...
.card {
  ...
  .component-setup();
  position: relative;
  margin-bottom: @card-bottom-margin / 2;
  padding: 0;
  ...
  // border highlight
  &.card-highlight {
    border: 3px solid @card-highlight-color;
  } 
...
.card-header {
  ...
  padding: 14px @component-padding;
  &.separator {
...
.card-actions {
  ...
  .btn-link {
    ...
    &[disabled]{
      ...
      color: @card-disabled-color !important;
      opacity: @card-disabled-opacity !important;
    }
  }
...
.card-header-actions {
  ...
  height: @card-header-actions-height;
  &:after {
    position: absolute;
    top: @card-header-actions-height - 4;
    left: 0;
    z-index: 10;
    display: block;
    width: 100%;
...
.card-select {
  .card {
    ...
    outline: 0 solid @card-focus-color;
  }
  .card:hover {
    outline: 3px solid  @card-focus-color;
  }
  .card.active {
    outline: 3px solid @card-focus-color;
  }
