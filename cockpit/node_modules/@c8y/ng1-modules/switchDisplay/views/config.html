<div class="switchDisplayConfig" ng-controller="switchDisplayConfig">
  <table class="table" ng-repeat-start="(index, switch) in switchesTemp">
    ...
    <tr>
      <td class="labels"><label translate>Value for active`switch`</label></td>
      <td class="labels"><label translate>Label for active`switch`</label></td>
      <td class="labels"><label translate>Value for inactive`switch`</label></td>
      <td class="labels"><label translate>Label for inactive`switch`</label></td>
    </tr>
    <tr>
  ...
  <p ng-if="config.switches.length === 0" class="has-error m-t-16">
