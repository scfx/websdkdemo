                  ...
                  <div class="card-block">
                    ...
                    >
                      ...
                      >
                        <i
                          ng-class="{
                            'dlt-c8y-icon-check-circle text-success':
                              rule.enabled && vm.hasSource(rule),
                            'dlt-c8y-icon-ban text-danger': !rule.enabled || !vm.hasSource(rule)
                          }"
                        ></i>
                        <span translate ng-if="rule.enabled && vm.hasSource(rule)">
                          Active`rule`
                        </span>
                        <span translate ng-if="!rule.enabled || !vm.hasSource(rule)">
                          Inactive`rule`
                    ...
                    <div class="smart-list-icon-label">
                      <span class="dot">
                        <i c8y-icon="{{ vm.inputIcon(rule) }}"></i>
                      </span>
                      <i c8y-icon="arrow-right"></i>
                      <span class="dot">
                        <i c8y-icon="{{ vm.outputIcon(rule) }}"></i>
                      </span>
                    </div>
