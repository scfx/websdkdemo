<div
  class="form-group has-feedback {{ form.htmlClass }} schema-form-textarea"
  ng-class="{
...
>
  ...
  <span class="help-block" sf-message="form.description | translate"></span>
</div>
