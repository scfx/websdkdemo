            ...
            <ng-form name="vm.defaultForm">
              <div class="form-group">
                ...
                <input
                  ...
                  ng-minlength="vm.property.schema.minLength"
                  ng-maxlength="vm.property.schema.maxLength"
                  ng-pattern="vm.property.schema.pattern"
                  ng-required="vm.validationsApplied.default"
                />
                <c8y-error-feedback field="vm.defaultForm.default"> </c8y-error-feedback>
              </div>
            </ng-form>
          </div>
