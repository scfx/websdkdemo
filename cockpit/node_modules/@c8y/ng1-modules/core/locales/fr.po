...
msgstr "(p.ex. \"c8y_UnavailabilityAlarm\". Le type d'alarme est affiché dans les détails de l'alarme.)"
...
msgstr "(aucun texte de commande ou description disponible)"
...
msgid "Actility LoRa"
msgstr "LoRa Actility"

msgid "Actility LoRa provider settings"
msgstr "Paramètres du fournisseur LoRa Actility"
...
msgstr ""
"Les paramètres de connectivité Actility ThingPark sont déjà fournis.<br>\n"
"            Cliquez sur \"Mettre à jour les paramètres de connectivité\" ci-dessous pour les écraser."
...
msgstr "Ajoutez un appareil en cliquant sur le bouton ci-dessous."

msgid "Add a new command template above."
msgstr "Ajoutez un nouveau modèle de commande ci-dessus."
...
msgstr "Ajoutez ou sélectionnez une réponse."
...
msgstr "Ajoutez votre premier mappage d'alarme grâce au bouton de la barre d'action."
...
msgstr "Ajoutez votre premier point de terminaison en cliquant sur le bouton ci-dessous ou sur la barre d'action."
...
"      <b>{{ vm.resolve.domainName }}</b>. Veuillez utiliser à la place votre nouveau nom de domaine. Veuillez contacter notre équipe de support technique \n"
...
msgstr "Tous les appareils enfants sont déjà affectés au groupe"
...
msgstr "Supprimer également tous les appareils de l'actif sélectionné et de ses sous-actifs."
...
"              defined type."
msgstr ""
"Un <strong>rôle d'inventaire</strong> contient des autorisations qui peuvent être attachées à des groupes d'\n"
"              appareils.<br>\n"
"              Cliquez sur <i c8y-icon=\"plus-circle\" class=\"text-primary\"></i> pour ajouter une nouvelle autorisation. Le\n"
"              menu déroulant des autorisations vous permet de limiter en plus l'accès aux objets contenant le\n"
"              type défini."
...
msgstr "Appliquer le tableau de bord à tous les appareils de type <i>{{ type }}</i>"
...
msgstr "Modifiez vos critères de recherche ou vos critères de filtre."
...
msgstr "Consulter le <span>User guide</span>"
...
msgstr "Appareils enfants affectés au groupe."
...
msgstr "Cliquez ci-dessous pour ajouter votre première règle de traitement d'évènement."
...
msgid "Copy inventory roles from…"
msgstr "Copier les rôles de l'inventaire à partir de…"
...
msgstr "Impossible d'assigner des appareils enfants au groupe"

msgid "Could not assign devices to the group"
msgstr "Impossible d'assigner des appareils au groupe"
...
msgstr "Impossible de supprimer l'actif."
...
msgstr "Impossible de désaffecter l'actif."
...
msgstr "Les filtres de données définissent le jeu de données à transférer. Vous devez définir au moins un filtre."
...
msgstr "Appareils affectés au groupe."
...
msgstr "Afficher le bouton Appareils enfants"
...
"        <i class=\"text-primary dlt-c8y-icon-enter-bottom\"></i>\n"
"      </button>\n"
"      à côté des appareils cibles avec leurs enfants. Cliquez sur ce bouton pour afficher une liste \n"
"      de tous les appareils enfants de l'appareil cible sélectionné."
...
msgstr "Permettre un suivi anonyme pour améliorer l'expérience du produit"

msgid "Enable changing current value from UI (e.g. using Fieldbus widget)"
msgstr "Autoriser la modification de la valeur actuelle de l'interface utilisateur (p.ex. via le widget Fieldbus)"

msgid "Enable changing current value from UI (e.g. using Fieldbus widget)."
msgstr "Permet la modification de la valeur actuelle via l'interface utilisateur (p.ex. via le widget Fieldbus)."
...
msgid "Enable showing current value in UI (e.g. on Fieldbus widget)."
msgstr "Activer l'affichage de la valeur actuelle dans l'interface utilisateur (p.ex. sur le widget Fieldbus)."
...
msgstr "Appliquer l'authentification à deux facteurs aux utilisateurs ayant le rôle {{ vm.enforcedUsersGroup }}."
...
msgstr "Entrez les identifiants fournis par votre fournisseur SMS. Cela active les fonctionnalités de la plate-forme qui utilisent les services SMS (p.ex. l'authentification à deux facteurs et les notifications utilisateur)."
...
msgstr "Filtrer les règles de traitement d'événement"
...
msgstr ""
"Pour un comportement correct de l'application, vous ne pouvez utiliser que les valeurs {{ vm.defaultRedirectUrl }} ou\n"
"              {{ vm.host }}, il est recommandé d'utiliser d'abord la première."
...
"        dans des accolades sans autre expression, p.ex. <var ng-non-bindable>{{ placeholderName }}</var>. Vous pouvez ensuite utiliser ce placeholderName dans les liaisons gérées par Angular.\n"
...
msgstr "Si cette option est sélectionnée, vous pourrez modifier les rôles affectés dans l'administration après la création de l'utilisateur. Dans le cas contraire, les rôles seront synchronisés avec le serveur d'autorisation à chaque connexion."
...
msgstr "Inclure des caractères en minuscules (p.ex. abcdef)"
...
msgstr "Procole d'appareil LPWAN"
...
msgstr "120 caractères maximum autorisés."
...
msgstr "La valeur minimale est de {{ delay }}."
...
msgstr "Doit être une clé de certificat de produit valide, p.ex. P_001F_EDCB_01"
...
msgstr "Filtre nom, description et type d'appareil"
...
msgstr "Nouvelle opération en masse"
...
msgstr "Nouveau protocole de l'appareil"
...
msgstr "Aucun paramètre du fournisseur LoRa trouvé. Il faut configurer les paramètres de connectivité."
...
msgstr "Aucun contrat actif avec des emplacements libres disponibles."
...
msgstr "Aucun protocole d'appareil n'est configuré. Créez un protocole d'appareil LoRa sur la page Protocoles d'appareil."
...
msgstr "Aucune règle de traitement d'événement trouvé."
...
msgstr "Aucun microprogramme défini. Ajoutez un microprogramme"
...
msgstr "Aucun objet géré correspondant."
...
msgstr "Aucune notification reçue pour l'instant."
...
msgstr "Ouvrir le <span>User guide</span>."
...
msgstr ""
"Le chemin pour les binaires peut varier en fonction de l'implémentation de l'agent de l'appareil, p.ex. :\n"
"    /firmware/binaries/firmware1.bin\n"
"    https://firmware/binary/123\n"
"    ftp://firmware/binary/123.tar.gz"
...
msgstr "Espaces réservés : {tenant-domain}, {host}, {token}. Le lien complet pour définir le mot de passe peut être p.ex. : {tenant-domain}/apps/devicemanagement/index.html?token={token}"
...
msgstr ""
"Plugins actuellement installés pour cette application. La mise à niveau de l'application ne\n"
"            modifiera aucun de ces plugins."

msgid ""
"Plugins included with the application. These plugins are required for running the\n"
"          application and cannot be removed."
msgstr ""
"Plugins compris avec l'application. Ces plugins sont nécessaires pour lancer\n"
"          l'application et ne peuvent pas être supprimés."
...
msgstr "Valeurs possibles : \"true\", \"false\", ou une date spécifique jusqu'à laquelle un utilisateur devrait rester actif, p.ex. \"{{ exampleDate }}\". Si ce champ est vide, la valeur sera définie sur \"true\"."
...
msgstr "Les valeurs des plages de début et de fin ne doivent pas être identiques."
...
msgstr "Résultats de recherche récents"
...
msgstr "Référez-vous à une ressource en utilisant le format suivant : /Objet/Instance/Ressource, p.ex. /3303/0/5700."
...
msgstr "Affinez ou effacez les filtres."
...
msgstr "Actualiser les ressources des appareils"

msgid "Refresh device resources as part of connecting"
msgstr "Actualiser les ressources des appareils lors de l'établissement de la connexion"
...
msgid "Rule info"
msgstr "Informations sur la règle"
...
msgstr "Planifier une opération en masse"
...
msgstr "Sélectionner application"
...
msgstr "L'option \"Tous les objets\" permet de synchroniser tous les types d'objets, y compris les objets internes et techniques (et pas seulement les groupes et les appareils). Cela peut entraîner des erreurs sur le gérant cible."
...
msgstr "Afficher les appareils enfants cibles"
...
"    server."
msgstr ""
"Certains paramètres utilisateur ne peuvent pas être modifiés car ils sont gérés par votre serveur\n"
" d'autorisation."
...
msgstr "Commencez votre saisie pour rechercher, p.ex. {{ example }}"
...
msgstr "Pour l'option TOTP, l'option Autoriser l'authentification à deux facteurs doit être activée."
...
msgstr "Table des propriétés de l'appareil, p.ex. nom, type ou notes."
...
msgstr "L'URL Actility ThingPark peut être différente selon le type de compte utilisé (p.ex. édition Community ou Enterprise). Il s'agit d'un champ facultatif, si rien n'est entré à cet endroit, les paramètres par défaut sont repris de l'agent."
...
"                      path"
msgstr ""
"L'application est remplacée par une application personnalisée partageant le même\n"
"                      chemin"
...
msgstr "L'application par défaut spécifie l'application qui s'affiche par défaut lors de la connexion à la plateforme. Elle s'applique à tous les utilisateurs du locataire. Sélectionnez une application dans la liste ci-dessous et assurez-vous que tous les utilisateurs peuvent accéder à cette application."
...
msgstr "Cette opération peut prendre quelques minutes. Pendant cette période, il se peut que l'application soit indisponible. Souhaitez-vous continuer cette action ?"
...
msgstr "Aucun identifiant n'est indiqué actuellement.<br>Veuillez indiquer des identifiants."
...
msgstr "Il n'y a aucun rapport défini"
...
msgstr "Cette application ne contient aucun plugin."
...
msgstr "Ce tableau de bord est partagé entre tous les appareils du type <i>{{ type }}</i>."
...
msgstr ""
"Cette fonctionnalité est obsolète. Bien qu'elle soit toujours fonctionnelle, utilisez plutôt la fonction \n"
"    <a href=\"/apps/administration#roles\">Rôles</a> pour définir des autorisations."
...
msgstr "Utilisez un filtre ou allez à la table des données de l'actif pour afficher tous les appareils et les groupes."
...
msgstr "Nom d'utilisateur (p.ex. e-mail)"
...
msgstr "Veuillez patienter pendant le chargement des groupes du gérant actuel…"

msgid "Wait while provider settings are loaded…"
msgstr "Veuillez patienter pendant le chargement des paramètres fournisseurs…"
...
msgstr "Vous allez supprimer l'actif : \"{{name}}\". Cette opération est irréversible. Souhaitez-vous continuer cette action ?"
...
msgid "You are about to delete device: \"{{ name }}\". Do you want to proceed?"
msgstr "Vous êtes sur le point de supprimer : \"{{ name }}\". Souhaitez-vous continuer cette action ?"
...
msgstr "Vous allez supprimer des plugins de l'application \"{{ humanizedAppName }}\". Cette opération peut prendre quelques minutes. Pendant cette période, il se peut que l'application ne soit pas disponible. Souhaitez-vous continuer cette opération ?"
...
msgstr "Vous allez désaffecter l'actif \"{{name}}\". Souhaitez-vous continuer cette action ?"
...
msgstr "Vous pouvez entrer une série de commandes d'environnement LWM2M. Chaque commande sera envoyée à tous les appareils LWM2M récemment enregistrés."
...
msgstr "Vous n'avez pas l'autorisation nécessaire pour gérer les rôles d'inventaire pour {{ vm.user }}."
...
msgstr "Vous avez atteint la limite de {{ vm.limitStatus.limit }} appareils. Aucun appareil supplémentaire ne peut être enregistré."
...
msgstr "Vous allez être déconnecté pour appliquer votre nouveau mot de passe. Souhaitez-vous continuer cette action ?"
...
msgstr "p.ex. Connectivité Cloud"
...
msgid "e.g. ModelName"
msgstr "p.ex. NomModèle"

msgid "e.g. ModelName, you can use an asterisk (*) as wildcard character"
msgstr "p.ex. NomModèle, vous pouvez utiliser un astérisque (*) comme caractère générique"
...
msgstr "p.ex. c8y.onmicrosoft.fr"
...
msgstr "{{ deviceCount }} appareils sélectionnés"
