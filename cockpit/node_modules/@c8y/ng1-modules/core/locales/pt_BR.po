...
msgstr "(p.ex. \"c8y_UnavailabilityAlarm\". O tipo de alarme pode ser encontrado nos detalhes do alarme.)"
...
msgstr "1 dispositivo selecionado"
...
msgstr "Um SMS de confirmação foi enviado para o número fornecido na etapa anterior. Antes de concluir a configuração, certifique-se de que o recebeu."
...
msgstr "Um link para fontes remotas existentes (p.ex. fontes do Google)"
...
msgstr "Definições do provedor Actility LoRa"
...
msgstr ""
"As configurações de conectividade do Actility ThingPark já foram fornecidas.<br>\n"
"            Clique em \"Atualizar definições de conectividade\" abaixo para substituí-las."
...
msgstr "Adicione um dispositivo clicando no botão abaixo."

msgid "Add a new command template above."
msgstr "Adicione um novo template de comandos acima."
...
msgstr "Adicione ou selecione uma resposta."
...
msgstr "Adicione seu primeiro snapshot de configuração por meio do botão na barra de ferramentas."

msgid "Add your first endpoint by clicking the button below or on the action bar."
msgstr "Adicione seu primeiro ponto de extremidade clicando no botão abaixo ou na barra de ferramentas."
...
"      <b>{{ vm.resolve.domainName }}</b>, em vez disso use seu novo nome de domínio. Se você encontrar algum problema ao acessar seu tenant,\n"
...
msgstr "Todos as aplicações"

msgid "All child devices are already assigned to the group"
msgstr "Todos os dispositivos secundários já estão atribuídos ao grupo"
...
msgstr "Todos os dispositivos processados com sucesso."
...
msgstr "Exclua também todos os dispositivos dentro do ativo selecionado e seus subativos."
...
msgstr "Excluir também o proprietário do dispositivo associado."
...
msgstr "Não foi possível atualizar o arquivamento da aplicação."
...
msgstr "O arquivamento da aplicação foi carregado."
...
msgstr "Chave de sessão da aplicação"
...
msgstr "Aplicar o dashboard a todos os dispositivos do tipo <i>{{ type }}</i>"
...
msgstr "Aplicativos de marca criados."
...
msgstr "Pode gerenciar remotamente os ativos enviando operações para o dispositivo. Isso inclui, p.ex., configuração remota, atualização de software, etc."
...
msgstr "Altere seus critérios de pesquisa ou filtro."
...
msgstr "Verifique o <span>User guide</span>"
...
msgstr "Dispositivos secundários atribuídos ao grupo."
...
msgstr "Clique em <strong>Avançar</strong> depois de instalar a aplicação."
...
msgstr "Clique abaixo para adicionar sua primeira regra de processamento de evento."
...
msgstr "Não foi possível atribuir dispositivos secundários ao grupo"

msgid "Could not assign devices to the group"
msgstr "Não foi possível atribuir dispositivos ao grupo"
...
msgstr "Não foi possível excluir a aplicação atribuído a outros tenants."
...
msgstr "Não foi possível reativar a aplicação, pois ele não tem nenhuma versão ativa."
...
msgstr "Não foi possível cancelar a atribuição de ativos."
...
msgstr "Criar ou importar o primeiro template SmartREST."
...
msgstr "Os filtros de dados definem o conjunto de dados que serão encaminhados. Você deve definir pelo menos um filtro."
...
msgstr "Dispositivos atribuídos ao grupo."
...
msgstr "Exibir uma lista de comandos predefinidos"
...
msgstr "Exibir botão de dispositivos subordinados"
...
"        <i class=\"text-primary dlt-c8y-icon-enter-bottom\"></i>\n"
"      </button>\n"
"      ao lado de dispositivos com subordinados. Clique nele para exibir uma lista com todos os dispositivos subordinados do\n"
...
msgstr "Ativar o rastreamento anônimo para aprimorar a experiência do produto"

msgid "Enable changing current value from UI (e.g. using Fieldbus widget)"
msgstr "Ativar a alteração do valor atual na UI (p.ex. usando o widget Fieldbus)"

msgid "Enable changing current value from UI (e.g. using Fieldbus widget)."
msgstr "Ativar a alteração do valor atual na IU (p.ex. usando o widget Fieldbus)."

msgid "Enable owner"
msgstr "Ativar proprietário"

msgid "Enable showing current value in UI (e.g. on Fieldbus widget)"
msgstr "Ativar a exibição do valor atual na UI (p.ex. no widget Fieldbus)"
...
msgstr "Impor autenticação de dois fatores em usuários com função {{ vm.enforcedUsersGroup }}."
...
msgstr "Digite um número de telefone internacional válido, o formato aceito é +49 9 876 543 210."
...
msgstr "Insira as credenciais do seu provedor de SMS. Isso ativa os recursos da plataforma que utilizam os serviços SMS (p.ex. autenticação de dois fatores e notificações do usuário)."
...
"        P.ex., se um dispositivo for comprometido, os invasores podem ter amplo acesso à plataforma."
...
msgstr "Filtrar regras de processamento de eventos"
...
msgstr "Encontre e instale a <strong>aplicação Cumulocity IoT Sensor </strong>."
...
msgstr "Primeiro, você tem que fazer o upload do certificado apropriado clicando em \"Carregar certificado\"."
...
msgstr ""
"Para o comportamento correto da aplicação, deve usar somente valores {{ vm.defaultRedirectUrl }} ou\n"
"              {{ vm.host }}, recomenda-se usar o primeiro."
...
msgstr "Dá acesso a operações em massa e aplicações de gerenciamento de dispositivos. Não inclui acesso a nenhum dado de dispositivo."
...
msgstr "Se selecionado, você poderá alterar as funções atribuídas na Administração após a criação do usuário. Caso contrário, as funções serão sincronizadas com o servidor de autorização em cada login."
...
msgstr "Aplicativos de marca antigos excluídos."
...
msgstr "São permitidos 120 caracteres no máximo."
...
msgstr "Deve ser uma chave de certificado de produto válida, p.ex. P_001F_EDCB_01"
...
msgstr "Nome e tipo de dispositivo"
...
msgstr "Nome, descrição e filtro de tipo de dispositivo"
...
msgstr "Novo protocolo do dispositivo"
...
msgstr "Nenhuma configuração de provedor LoRa encontrada. As definições de conectividade devem ser configuradas."
...
msgstr "Ainda não foram definidos templates SmartREST."
...
msgstr "Nenhum contrato com slots livres disponível."
...
msgstr "Nenhum perfil de dispositivo."

msgid "No device protocols configured. Create a LoRa device protocol on the Device protocols page."
msgstr "Nenhum protocolo de dispositivos configurado. Crie um protocolo de dispositivo LoRa na página Protocolos de dispositivos."
...
msgstr "Nenhuma regra de processamento de eventos encontrada."
...
msgstr "Nenhum firmware definido. Adicione firmware"
...
msgstr "Não há objetos gerenciados correspondentes."
...
msgstr "Não foram encontradas propriedades."
...
msgstr "Tipo de fragmento do objeto (p.ex. c8y_IsDevice) para o qual concede permissão. Note que para ter acesso a um objeto, o usuário precisa ter acesso a todos os seus fragmentos. Use um asterisco (*) para conceder permissão ao tipo de fragmento de qualquer objeto."
...
msgstr "No limiar explícito da medição, criar alarme"
...
msgstr "Apenas são permitidos números, p.ex. 1528197925677."
...
msgstr "Abra o <span>User guide</span>"
...
msgstr ""
"O caminho para binários pode variar dependendo da implementação do agente do dispositivo, p.ex.:\n"
"    /firmware/binaries/firmware1.bin\n"
"    https://firmware/binary/123\n"
"    ftp://firmware/binary/123.tar.gz"
...
msgstr ""
"Plugins instalados no momento para esta aplicação. A atualização da aplicação não mudará\n"
"            nenhum desses plugins."

msgid ""
"Plugins included with the application. These plugins are required for running the\n"
"          application and cannot be removed."
msgstr ""
"Plugins incluídos na aplicação. Esses plugins são necessários para executar a aplicação\n"
...
msgstr "Valores possíveis: \"true\", \"false\" ou uma data específica até a qual o usuário deve permanecer ativo, p.ex. \"{{ exampleDate }}\". Se for deixada em branco, será definido o valor\" true\"."
...
msgstr "Os valores inicial e final do intervalo não devem ser iguais."
...
msgstr "Resultados de pesquisa recentes"
...
msgstr "Consulte um recurso usando o seguinte formato: /Objeto/Instância/Recurso, p.ex. /3303/0/5700."
...
msgstr "Refine ou limpe os filtros."
...
msgid "Rule info"
msgstr "Informações sobre a regra"
...
msgstr "A estratégia de SMS requer que o aplicação de mensagens seja assinado."
...
msgstr "Agendar operação em massa"
...
msgstr "Selecionar um evento de alteração de local uma vez por 60 segundos"
...
msgstr "Selecione o aplicação que gostaria de visualizar."
...
msgstr "Selecionar a opção \"Todos os objetos\" sincronizará todos os tipos de objetos, incluindo os internos e técnicos (não apenas grupos e dispositivos). Isso pode causar problemas no tenant de destino."
...
msgid "Show &quot;Software changes&quot;"
msgstr "Exibir &quot;Alterações de software&quot;"
...
msgstr "Mostrar dispositivos com ativos"
...
msgstr "Mostrar dispositivos secundários de destino"
...
msgid "Software info"
msgstr "Informações sobre o software"
...
"    server."
msgstr ""
"Algumas das configurações do usuário não podem ser editadas aqui porque são gerenciadas através\n"
...
msgstr "Comece a digitar para pesquisar, p.ex., {{ example }}"
...
msgstr "TOTP necessita que 'Permitir autenticação de dois fatores' esteja ativado."
...
msgstr "Tabela de propriedades do dispositivo, p.ex. nome, tipo ou notas."
...
"- digite \"http://my.host.com.br, http://myother.host.com.br\" para permitir que aplicações de http://my.host.com.br e de http://myother.host.com.br se comuniquem com a plataforma,\n"
...
msgstr "O URL do Actility ThingPark pode diferir dependendo do tipo de conta usada (p.ex. Community ou Enterprise Edition). Este é um campo opcional, se nada for inserido aqui, a configuração padrão é obtida do agente."
...
"                      path"
msgstr ""
"A aplicação é substituída por uma aplicação personalizada que compartilha o mesmo\n"
"                      caminho"
...
msgstr "A aplicação padrão especifica a aplicação que aparece por padrão ao fazer login na plataforma. Aplica-se a todos os usuários do tenant. Selecione uma aplicação na lista abaixo e verifique se todos os usuários podem acessar essa aplicação."
...
msgstr ""
"A ID externa é algo que liga as informações do dispositivo e o mundo físico (p.ex. Número de série, IMEI).\n"
"\n"
...
msgstr "A operação pode levar vários minutos. Durante esse período, a aplicação pode estar indisponível. Deseja continuar?"
...
msgstr "Ainda não há credenciais fornecidas.<br>Forneça algumas."
...
msgstr "Esse aplicação não contém plugins."

msgid "This application is already assigned to tenant \"{{tenant}}\"."
msgstr "Essa aplicação já está atribuído ao tenant \"{{tenant}}\"."

msgid "This application is already made available in a global role"
msgstr "Essa aplicação já está disponível em um papel global"

msgid "This application is not accessible by the owner."
msgstr "Essa aplicação não é acessível pelo proprietário."

msgid "This application is overridden."
msgstr "Essa aplicação foi substituída."

msgid "This application was duplicated from \"{{name}}\" and won't get any further updates from it."
msgstr "Essa aplicação foi duplicada a partir de \"{{name}}\" e não receberá mais atualizações."

msgid "This dashboard is shared between all devices of the type <i>{{ type }}</i>."
msgstr "Esse dashboard é compartilhado entre todos os dispositivos do tipo <i>{{ type }}</i>."
...
msgstr ""
"Este recurso será descontinuado. Embora ainda esteja totalmente funcional, é melhor usar o novo recurso \n"
...
msgstr "Para alterar o idioma em todo a aplicação, recomendamos recarregar a página. Se você tiver alterações ainda não salvas, poderá recarregar mais tarde. Como você gostaria de proceder?"
...
msgstr "Para alterar a opção de rastreamento em todo a aplicação, você precisa recarregar a página. Se você tiver alterações ainda não salvas, poderá recarregar mais tarde. Como você gostaria de proceder?"

msgid "To see the result click <a href=\"#/device/{{deviceId}}/control\">here</a>"
msgstr "Para ver o resultado, clique <a href=\"#/device/{{deviceId}}/control\">aqui</a>"

msgid "To view the contents of \"README\", add the file \"README.md\" to the package."
msgstr "Para visualizar o conteúdo do \"README\", adicione o arquivo \"README.md\" ao pacote."
...
msgstr "Ativar navegador"

msgid "Toggle operation"
msgstr "Ativar operação"
...
msgstr "Ativar estado do simulador"
...
msgstr "URL de onde o token OAuth é solicitado (obrigatório se for escolhido o método OAuth)"
...
msgstr "Cancelar atribuição de ativo"
...
msgstr "Use um filtro ou vá para a tabela de dados de ativos para mostrar todos os dispositivos e grupos."
...
msgstr "Acesso do usuário à aplicação alterado."
...
msgstr "Aguarde enquanto os grupos para o tenant atual são carregados…"

msgid "Wait while provider settings are loaded…"
msgstr "Aguarde enquanto as configurações do provedor são carregadas…"
...
msgstr "Com essa aplicação você pode"
...
msgstr "Você está prestes a excluir o aplicação \"{{app | humanizeAppName}}\". Deseja continuar?"
...
msgstr "Você está prestes a excluir o ativo \"{{name}}\". Esta operação é irreversível. Deseja continuar?"
...
msgstr "Você está prestes a recarregar a aplicação para ver as alterações: Deseja continuar?"
...
msgstr "Você está prestes a remover os plugins da aplicação \"{{ humanizedAppName }}\". A operação pode levar vários minutos. Durante esse período, o aplicação poderá estar indisponível. Deseja continuar?"
...
msgstr "Você está prestes a cancelar a atribuição do ativo \"{{name}}\". Deseja continuar?"
...
msgstr "Você pode inserir um conjunto de comandos shell LWM2M. Cada um deles será enviado para cada dispositivo LWM2M registrado recentemente."
...
msgstr "Você não tem a permissão necessária para gerenciar o acesso à aplicação para {{ user.userName }}."

msgid "You don't have the permission required to manage inventory roles for {{ vm.user }}."
msgstr "Você não tem a permissão necessária para gerenciar as funções de inventário para {{ vm.user }}."
...
msgstr "Você não fez o upload de uma aplicação válido."
...
msgstr "Você deve ativar pelo menos um ponto de dados."
...
msgstr "Você atingiu o limite de dispositivos {{ vm.limitStatus.limit }}. Não é possível registrar mais dispositivos."
...
msgstr "Você será desconectado para aplicar sua nova senha. Deseja continuar?"
...
msgstr "p.ex. Conectividade em nuvem"
...
msgstr "p.ex. Minha aplicação externo"
...
msgstr "p.ex. https://login.microsoftonline.com.br"
...
msgstr "obtém o ID do dispositivo e redireciona o usuário para a exibição de detalhes do grupo, p.ex."
...
msgstr "{{ deviceCount }} dispositivos selecionados"
