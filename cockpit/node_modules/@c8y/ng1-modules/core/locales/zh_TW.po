...
msgstr "\"檢查使用者許可權\"部分允許您驗證為選定的設備使用者授予的許可權，這些許可權還可以從父設備繼承或指派給全域角色。\"授予許可權\"部分允許您檢查和管理設備的許可權。"
...
msgstr "\"{{description | translate}}\" 失敗，原因是：\"{{failureReason | translate}}\"。"

msgid "\"{{description | translate}}\" failed."
msgstr "\"{{description | translate}}\" 失敗。"

msgid "\"{{description | translate}}\" will be executed."
msgstr "將會執行 \"{{description | translate}}\"。"

msgid "\"{{field}}\" must be less than or equal to {{maxValue}}"
msgstr "\"{{field}}\" 必須小於或等於 {{maxValue}}"
...
msgstr "\"{{operation.description | translate}}\" 失敗，原因是：\"{{operationResult.failureReason | translate}}\"。"

msgid "\"{{operation.description | translate}}\" failed."
msgstr "\"{{operation.description | translate}}\" 失敗。"

msgid "\"{{operation.description | translate}}\" will be executed."
msgstr "將會執行 \"{{operation.description | translate}}\"。"
...
msgid "(e.g. \"c8y_UnavailabilityAlarm\". The alarm type can be found in the alarm details.)"
msgstr "（如 \"c8y_UnavailabilityAlarm\"。可以在警報詳細資訊中找到警報類型。）"

msgid "(file size up to {{ maxFileSizeKB }} KB)"
msgstr "（檔案大小最大 {{ maxFileSizeKB }} KB）"
...
msgstr "<small>支援的格式：OpenSSHv1、OpenSSHv2、PEM、SSH2。<br />支援的演算法：RSA、DSA、ECDSA、ED25519。</small>"

msgid "<small>Supported formats: OpenSSHv1, OpenSSHv2, PEM, SSH2.<br />Supported algorithms: RSA, DSA.</small>"
msgstr "<small>支援的格式：OpenSSHv1、OpenSSHv2、PEM、SSH2。<br />支援的演算法：RSA、DSA。</small>"

msgid "<span title=\"Two-factor authentication\">TFA</span> settings"
msgstr "<span title=\"Two-factor authentication\">TFA</span> 設置"

msgid ""
"<strong>No validation for this resource.</strong> Add a validation rule by clicking\n"
"            below."
msgstr ""
"<strong>此資源無驗證。</strong>通過在下面按一下\n"
"來添加驗證規則。"
...
"                  inventory."
msgstr ""
"<strong>全域角色</strong>包含通常適用的許可權。例如，\n"
"                  在 \"庫存\" 行中選取 \"讀取\" 將允許具有此角色的使用者讀取\n"
"                  庫存中的所有物件。"
...
msgstr "確認簡訊已發送到上一步提供的號碼。完成配置前，請確保已收到。"
...
msgstr "確認人：{{ackBy}} {{ackTimeFromNow}}"
...
msgstr "活動：已觸發 {{alarmTimeFromNow}}"
...
msgid "Actility LoRa provider settings"
msgstr "Actility LoRa 提供商設置"

msgid "Actility ThingPark URL"
msgstr "Actility ThingPark URL"

msgid ""
"Actility ThingPark connectivity settings are already provided.<br>\n"
"            Click \"Update connectivity settings\" below to overwrite them."
msgstr ""
"已提供 Actility ThingPark 連接設置。<br>\n"
"            按一下下麵的 \"更新連接設置\" 可將其覆蓋。"
...
msgstr "啟動此功能將造成設備發送新蜂窩基站 ID 資料時自動更新設備的 GPS 位置。使用此功能會造成附加成本。"
...
msgstr "通過在下面按一下來添加資料訂閱。"

msgid "Add a device by clicking on the button below."
msgstr "按一下下面的按鈕添加設備。"

msgid "Add a new command template above."
msgstr "在上面添加新命令模板。"

msgid "Add a new device profile by clicking below."
msgstr "通過在下方按一下來添加新設備設定檔。"

msgid "Add a new firmware by clicking below."
msgstr "通過在下方按一下來添加新韌體。"

msgid "Add a new mapping by clicking below."
msgstr "通過在下方按一下來添加新映射。"

msgid "Add a new property by clicking below."
msgstr "在下麵按一下來添加新屬性。"

msgid "Add a new software by clicking below."
msgstr "通過在下方按一下來添加新軟體。"

msgid "Add a new version by clicking below."
msgstr "通過在下方按一下來添加新版本。"
...
msgid "Add or select a response."
msgstr "添加或選取回應。"
...
msgstr "添加第一條消息後，將在此處顯示 CSV 預覽。"

msgid "After adding your first response, the CSV preview will be shown here."
msgstr "添加第一個回應後，將在此處顯示 CSV 預覽。"

msgid ""
"After completing the process you will no longer be able to access your tenant with\n"
"      <b>{{ vm.resolve.domainName }}</b>, instead use your new domain name. If you encounter any problems accessing your tenant,\n"
"      please contact support."
msgstr ""
"完成流程後，您將不能使用\n"
"      <b>{{ vm.resolve.domainName }}</b> 訪問租戶，請改用新的域名。如果您在訪問租戶時遇到任何問題，\n"
"      請聯繫支持人員。"
...
msgstr ""
"完成該過程後，您將不再能夠使用您的自訂域名訪問租戶，\n"
"而是使用您的舊域名。\n"
"如果您在訪問租戶時遇到任何問題，請與支援部門聯繫。"
...
msgstr ""
"完成啟動後，您將不再能夠使用 <code>{{ vm.domainName }}</code> 訪問租戶\n"
"，請改用新的自訂域名 <code>{{ vm.newDomainName }}</code>。"
...
msgstr "警報映射基於警報類型匹配自動轉換說明和嚴重性。警報類型是在平臺上創建的每個警報的已定義屬性。"
...
msgstr "警報狀態已更改為 \"{{status | translate}}\"。"
...
msgid "All child devices are already assigned to the group"
msgstr "所有子設備都已指派給群組"
...
msgstr "具有此證書簽名的認證的所有設備將無需事先註冊即可與平臺通信。"

msgid "All direct and indirect sub-users of the deleted user will be deleted."
msgstr "已刪除用戶的所有直接和間接子用戶都將被刪除。"
...
msgstr "允許執行創建、更新和刪除操作"

msgid "Allows for seeing status and operating Modbus device"
msgstr "允許檢視狀態和操作 Modbus 設備"

msgid "Also delete all devices inside selected asset and its subassets."
msgstr "同時刪除所選資產及其子資產中的所有設備。"

msgid "Also delete all devices inside this group and its subgroups."
msgstr "還會刪除此組及其子組內的所有設備。"

msgid "Also delete associated device owner \"{{owner}}\"."
msgstr "同時刪除關聯的設備所有者 \"{{owner}}\"。"
...
msgstr ""
"<strong>庫存角色</strong>包含可附加到設備\n"
"        和設備組的許可權。您可以在<a href=\"#/roles/inventory_roles\">此處</a>定義庫存角色。"
...
"          設備群組的許可權。<br>\n"
"          按一下 <i c8y-icon=\"plus-circle\" class=\"text-primary\"></i> 可添加新許可權。\n"
"          在許可權下拉清單中，可進一步將訪問權限限制到包含\n"
"          所定義類型的物件。"
...
msgstr "應用程式 \"{{appName | humanizeAppName}}\" 現在是租戶的預設應用程式。"
...
msgstr "具有以下值 ({{valuesList}}) 的租戶 \"{{tenant}}\" 的應用程式已存在。"
...
msgid "Apply dashboard to all devices of type <i>{{ type }}</i>"
msgstr "將儀錶板應用於類型為 <i>{{ type }}</i> 的所有設備"

msgid "Apply dashboard to all devices of type {{ type }}"
msgstr "將儀錶板應用於類型為 {{ type }} 的所有設備"

msgid "Apply dashboard to all devices of type {{ type }} (permission required)"
msgstr "將儀錶板應用於類型為 {{ type }} 的所有設備（需要許可權）"
...
msgstr "陣列太短 ({{ value.length }})，最少 {{ schema.minItems }}。"
...
msgstr "將設備設定檔 {{profileName}} 指派給設備 {{deviceName}}"
...
msgstr "將新擁有者指派給已刪除用戶的所有直接子用戶。"

msgid "At least 1 data point must be selected"
msgstr "必須選取至少 1 個資料點"
...
msgstr "通過與所選引用設備進行比較來審核目前設備，將已檢查屬性同步到引用設備值"
...
msgstr "在“遠端存取”選項卡上自動儲存第一個連接的主機金鑰。"
...
msgstr "自動發現失敗，原因是：\"{{ failureReason | translate }}\"。"
...
msgstr "可用預留位置：{tenant-domain}、{host}、{binaryId}。可下載檔案的完整連結為：{tenant-domain}/inventory/binaries/{binaryId}。"
...
msgstr "在<a c8y-guide-href=\"users-guide/cockpit/\">此處</a>瀏覽手冊。"
...
msgstr "批量操作延遲必須大於 {{minSeconds}} 秒。"
...
msgstr "已創建 CEP 模組 \"{{name}}\""

msgid "CEP module \"{{name}}\" deleted"
msgstr "已刪除 CEP 模組 \"{{name}}\""

msgid "CEP module \"{{name}}\" updated"
msgstr "已更新 CEP 模組 \"{{name}}\""
...
msgstr "已清除：在 {{alarmDuration}} 內處於活動狀態"
...
msgstr "可管理租戶範圍配置，例如應用程式、租戶選項和保留規則"

msgid "Can read all data from all devices"
msgstr "可以讀取所有設備的所有資料"
...
msgstr "無法刪除具有關聯設備所有者的設備，因為此所有者仍指派給其他設備。嘗試僅移除此設備。"

msgid "Cannot deploy module due to error: \"{{ errorMessage | translate }}\"."
msgstr "由於出錯而無法部署模組：\"{{ errorMessage | translate }}\"。"
...
msgstr "更改此值會造成顯示錯誤的離線狀態並妨礙儘早創建警報"
...
msgstr "更改此值會造成顯示錯誤的線上狀態並妨礙儘早創建警報"
...
msgstr "檢查 Fresenius TDMS 伺服器 IP"

msgid "Check Fresenius TDMS server port"
msgstr "檢查 Fresenius TDMS 伺服器埠"

msgid "Check MQTT enablement"
msgstr "檢查 MQTT 啟用"

msgid "Check MQTT keepalive interval"
msgstr "檢視 MQTT keepalive 間隔時間"

msgid "Check for the existence of \"{{fragmentPath}}\" fragment"
msgstr "檢查是否存在 \"{{fragmentPath}}\" 片段"

msgid "Check if TCS:BUS plugin enabled"
msgstr "檢視是否已啟用 TCS:BUS 外掛程式"

msgid ""
"Check the\n"
"          <a c8y-guide-href=\"users-guide/device-management/#bulk-operation-wizard\">User guide`KEEP_ORIGINAL`</a>\n"
"          for more details."
msgstr ""
"查閱\n"
...
msgid "Check the <span>User guide`KEEP_ORIGINAL`</span>"
msgstr "檢查 <span>User guide</span>"
...
msgid "Child devices assigned to the group."
msgstr "子設備已指派給群組。"
...
msgstr "壓縮檔必須在根目錄中有一個 index.html。Web 應用程式中的 URL 則可以是相對的。"
...
msgstr "配置 Eifeler Vacotec 伺服器連接埠"

msgid "Config Fresenius TDMS server IP"
msgstr "配置 Fresenius TDMS 伺服器 IP"

msgid "Config Fresenius TDMS server port"
msgstr "配置 Fresenius TDMS 伺服器連接埠"

msgid "Config MQTT keepalive interval (in seconds)"
msgstr "配置 MQTT keepalive 間隔（秒）"
...
msgstr ""
"在平臺中針對租戶創建和\n"
"              平臺升級創建預設訂閱。要顯示可用應用程式的完整清單，請覆蓋繼承的\n"
"              設置。"
...
msgstr "無法接受所有待處理的註冊請求。"

msgid "Could not access SSH server on endpoint \"{{endpointName}}\". Provided credentials for user \"{{userName}}\" are incorrect."
msgstr "無法訪問端點 \"{{endpointName}}\" 上的 SSH 伺服器。為使用者 \"{{userName}}\" 提供的憑據不正確。"

msgid "Could not activate custom domain. DNS setup is incorrect."
msgstr "無法啟動自訂域。DNS 設置不正確。"

msgid "Could not add certificate. Certificate with {{fingerprint}} fingerprint already exists."
msgstr "無法添加證書。帶 {{fingerprint}} 指紋的證書已存在。"

msgid "Could not add identity. External ID \"{{externalId}}\" of the type \"{{type}}\" already exists."
msgstr "無法添加標識。\"{{type}}\" 類型的外部 ID \"{{externalId}}\" 已存在。"

msgid "Could not assign child devices to the group"
msgstr "無法將子設備指派給群組"

msgid "Could not assign devices to the group"
msgstr "無法將設備指派給群組"
...
msgstr "無法連接到端點 \"{{endpointName}}\"。無法使用主機 {{host}} 的指紋 {{fingerprint}} 通過埠 {{port}} 驗證 {{keyType}} 主機金鑰。如果您需要此金鑰，請從配置中移除前一個金鑰以允許連接。"

msgid "Could not copy to clipboard, press Ctrl/Cmd+C to copy."
msgstr "無法複製到剪貼板，請按下 Ctrl/Cmd+C 複製。"

msgid "Could not copy to clipboard."
msgstr "無法複製到剪貼板。"

msgid "Could not create a tenant. Tenant with given domain/URL already exists."
msgstr "無法創建租戶。具有給定域/URL 的租戶已存在。"
...
msgstr "無法刪除已指派到其他租戶的應用程式。"

msgid "Could not delete asset."
msgstr "無法刪除資產。"
...
msgstr "無法部署模組 \"{{moduleName}}\"。運算式 \"{{expression}}\" 編譯失敗：編譯方言 \"{{scriptDialect}}\" 的腳本 \"{{scriptName}}\" 時出現異常：語句 \"{{affectedStatement}}\" 前缺少 \"{{missingSyntax}}\"。"
...
msgstr "無法部署模組 \"{{moduleName}}\"。運算式 \"{{expression}}\" 編譯失敗：所保留關鍵字 \"{{keyword}}\" 附近第 {{line}} 行第 {{column}} 列上 \"{{incorrectExpression}}\" 附近的語法不正確。"
...
msgstr "無法部署模組 \"{{moduleName}}\"。運算式 \"{{expression}}\" 編譯失敗：行 {{line}} 列 {{column}} \"{{incorrectExpression}}\" 附近的語法不正確，請檢查 \"where\" 子句。"
...
msgstr "無法部署模組 \"{{moduleName}}\"。運算式 \"{{expression}}\" 編譯失敗：行 {{line}} 列 {{column}} \"{{incorrectExpression}}\" 附近的語法不正確。"

msgid "Could not download the file: object with ID \"{{ id }}\" is not a valid binary."
msgstr "無法下載檔案：ID 為 \"{{ id }}\" 的對象不是有效的二進位檔案。"
...
msgstr "無法訂閱微服務，因為已訂閱具有同一上下文路徑的另一個應用程式。"

msgid "Could not unassign asset."
msgstr "無法取消指派資產。"
...
msgstr "無法更新使用者 \"{{username}}\"。"

msgid "Could not upload the files."
msgstr "無法上傳檔案。"

msgid "Could not use a reserved SQL keyword \"{{tenantId}}\" as a domain name."
msgstr "無法使用保留的 SQL 關鍵字 \"{{tenantId}}\" 作為域名。"
...
msgstr "在 1 號 RS232 介面上使用 DDCMP"

msgid "DDCMP on RS232 #2"
msgstr "在 2 號 RS232 介面上使用 DDCMP"
...
msgstr "在 1 號 RS232 介面上使用 DEX"

msgid "DEX on RS232 #2"
msgstr "在 2 號 RS232 介面上使用 DEX"
...
msgstr "已複製儀錶板。導航到所需設備並選取 \"粘貼儀錶板\""
...
msgstr "資料代理處理目前超載，可能會停止轉發資料。請聯繫支援人員。"
...
msgstr "資料代理處理無法連接到目標租戶，因此資料轉發不起作用。請聯繫支援人員。"
...
msgstr "資料與 \"anyOf\" 中的任何架構都不匹配。"

msgid "Data does not match any schemas from \"oneOf\"."
msgstr "資料與 \"oneOf\" 中的任何架構都不匹配。"
...
msgid "Data filters define the set of data to be forwarded. You must set at least one filter."
msgstr "資料篩選器定義要轉發的資料集。您必須至少設置一個篩選器。"

msgid "Data logging"
msgstr "資料記錄"

msgid "Data matches more than one schema from \"oneOf\"."
msgstr "資料與 \"oneOf\" 中的多個方案匹配。"

msgid "Data matches schema from \"not\"."
msgstr "資料與 \"not\" 中的架構匹配。"
...
msgstr "以租戶管理員身份停用支援訪問將禁用租戶上的所有其他支援請求。"
...
msgstr "找到標識 {{type}} 的設備：{{externalId}}。"
...
msgstr "設備位置可以由設備本身設置，也可以在平臺中手動設置"
...
msgstr "設備名稱：\"{{deviceName}}\"，警報文字：\"{{alarmText | translate}}\""

msgid "Device not assigned."
msgstr "未指派設備。"

msgid "Device owner not found for device \"{{name}}\"."
msgstr "未找到設備 \"{{name}}\" 的設備所有者。"
...
msgstr "支援 {{deviceManufacturer}} 製造的設備型號 {{deviceModel}} 的設備協定"
...
msgid "Devices assigned to the group."
msgstr "設備已指派到群組。"
...
msgid "Display child devices button"
msgstr "顯示子設備按鈕"
...
msgstr "已上傳證書的域名與正在使用的域名不同。請首先停用自訂域，然後再上傳新證書。"
...
msgstr "下載已訂閱目前租戶及其子租戶新聞稿的使用者的電子郵件清單。"
...
msgstr "物件 [{{id}}] 的 ParameterName \"{{name}}\" 重複，已重命名為 \"{{register.name}}\"。"
...
msgstr "租戶使用者的每個支援使用者請求都會將支援使用者訪問延長給定的小時數（預設值：24 小時）。將其留空會將值設置為 \"24\"。"
...
msgstr "啟用 Gainsight 產品體驗的追蹤"

msgid "Enable anonymous tracking to enhance the product experience"
msgstr "啟用匿名跟蹤以增強產品體驗"

msgid "Enable changing current value from UI (e.g. using Fieldbus widget)"
msgstr "啟用從 UI 更改目前值（例如使用 Fieldbus 小組件）"

msgid "Enable changing current value from UI (e.g. using Fieldbus widget)."
msgstr "啟用從 UI 更改目前值（如使用 Fieldbus 小組件）。"

msgid "Enable owner"
msgstr "啟用所有者"

msgid "Enable showing current value in UI (e.g. on Fieldbus widget)"
msgstr "在 UI 中啟用顯示目前值（例如在 Fieldbus 小組件上）"

msgid "Enable showing current value in UI (e.g. on Fieldbus widget)."
msgstr "啟用在 UI 中顯示目前值（例如在 Fieldbus 小組件上）。"

msgid "Enable two-factor authentication"
msgstr "啟用雙因素驗證"

msgid "Enable/disable MQTT communication"
msgstr "啟用/禁用 MQTT 通信"

msgid "Enable/disable TCS:BUS plugin"
msgstr "啟用/禁用 TCS:BUS 外掛程式"
...
msgstr "強制所有使用者使用 \"綠色\" 密碼"

msgid "Enforce TOTP setup for the user"
msgstr "針對使用者強制實施 TOTP 設置"

msgid "Enforce strong passwords (green)"
msgstr "強制執行強式密碼（綠色）"

msgid "Enforce that all passwords are strong (green)"
msgstr "強制所有密碼為強式密碼（綠色）"

msgid "Enforce two-factor authentication on all users"
msgstr "對所有使用者強制實施雙重身份驗證"

msgid "Enforce two-factor authentication on users with role {{ vm.enforcedUsersGroup }}."
msgstr "對角色為 {{ vm.enforcedUsersGroup }} 的用戶強制實施雙重身份驗證。"
...
msgstr "輸入有效的國際電話號碼，接受的格式為 +49 9 876 543 210。"

msgid "Enter address"
msgstr "輸入地址"

msgid "Enter one or more valid email addresses, separated with a comma."
msgstr "輸入一個或多個以逗號分隔的有效電子郵件地址。"

msgid "Enter starting fragment of device id or name to search."
msgstr "輸入設備 ID 或名稱的起始片段以搜尋。"

msgid "Enter the following code <code>{{ vm.code }}</code> to proceed:"
msgstr "輸入以下代碼 <code>{{ vm.code }}</code> 以繼續："

msgid "Enter the password of the user that you are currently logged in with."
msgstr "輸入您目前用於登錄的用戶的密碼。"

msgid "Enter valid international phone numbers. The accepted format is +49 9 876 543 210. Separate multiple numbers with a comma."
msgstr "輸入有效國際電話號碼。接受的格式為 +49 9 876 543 210。以逗號分隔多個數字。"

msgid "Enter your credentials from your SMS provider. This enables platform features that utilize SMS services (e.g. two-factor authentication and user notifications)."
msgstr "輸入您 SMS 提供商提供的認證。這會啟用利用 SMS 服務的平台功能（例如，雙重身份驗證和使用者通知）。"
...
msgstr "語句 {{moduleName}}:{{statementNumber}} 中出現錯誤。所保留關鍵字 \"{{keyword}}\" 附近運算式 \"{{expression}}\" 的附近語法不正確。"

msgid "Error message details"
msgstr "錯誤消息詳細資訊"

msgid "Error occurred while processing the uploaded file."
msgstr "處理已上傳的檔案時發生錯誤。"
...
msgstr "運行事件處理規則時發生錯誤。<br>請檢視<a href=\"/apps/devicemanagement/#/alarms\">創建的警報</a>，瞭解詳情。"
...
msgstr ""
"特意更改全域角色 \"設備\" 會產生安全性漏洞。例如，如果設備\n"
"        被感染，攻擊者可能具有憑條的擴展存取權限。"
...
msgstr "租戶 {{tenantId}} 的語句 \"{{moduleName}}\" 中出現異常：調用類 \"{{classPath}}\" 的方法 \"{{methodName}}\" 以傳遞語句 \"{{statement}}\": {{exceptionType}} : {{exceptionMessage}} 的參數 [{{parameters}}] 時出現調用異常。"

msgid "Exception on tenant {{tenantId}} in statement \"{{statement}}\": HTTP status code: {{httpStatusCode}} : {{message | translate}}"
msgstr "租戶 {{tenantId}} 的語句 \"{{statement}}\" 中出現異常：HTTP 狀態碼：{{httpStatusCode}} : {{message | translate}}"
...
msgstr "執行（通過 {{ deliveryType | translate }}）"

msgid "Execute command template"
msgstr "執行命令範本"

msgid "Execute generic command: {{command}}"
msgstr "執行通用命令：{{command}}"
...
msgstr "\"{{type}}\" 類型的外部 ID \"{{value}}\" 已存在。"
...
msgstr "未找到類型為 \"{{type}}\" 且值為 \"{{value}}\" 的外部 ID。"
...
msgstr "檢索 RDB 快照失敗：\"{{failureReason | translate}}\"。"
...
msgstr "已匯出的資料檔案可以從 {tenant-domain}/inventory/binaries/{binaryId} 下載。"
...
msgid "Filter event processing rules"
msgstr "篩選事件處理規則"
...
msgstr "找到並安裝 <strong>Cumulocity IoT 感測器應用程式</strong>。"
...
msgstr ""
"在\n"
"<a c8y-guide-href=\"users-guide/administration/#managing-applications\">User guide</a>中詳細瞭解可用應用程式。"
...
msgstr ""
"在\n"
"            <a c8y-guide-href=\"users-guide/cockpit/#smart-rules\"> User guide </a>中詳細瞭解。"
...
msgstr ""
"在\n"
"          <a c8y-guide-href=\"concepts/applications/\">Concepts guide</a>中詳細瞭解。"
...
msgstr ""
"在\n"
"          <a c8y-guide-href=\"users-guide/cockpit/#adding-alarms-or-events\">User guide</a>中詳細瞭解。"
...
msgstr ""
"在\n"
"          <a c8y-guide-href=\"users-guide/getting-started/\">User guide</a>中詳細瞭解。"
...
msgstr ""
"在\n"
"        <a c8y-guide-href=\"reference/retention-rules/\">Reference guide</a>中詳細瞭解。"
...
msgstr ""
"在\n"
"        <a c8y-guide-href=\"users-guide/administration/#reprio-alarms\">User guide</a>中詳細瞭解。"
...
msgstr ""
"在\n"
"        <a c8y-guide-href=\"users-guide/cockpit/#export\">User guide</a>中瞭解更多資訊。"
...
msgstr ""
"在\n"
"        <a c8y-guide-href=\"users-guide/device-management/#configuration-repository\">User guide</a>中詳細瞭解。"
...
msgstr ""
"在\n"
"      <a c8y-guide-href=\"users-guide/administration/#event-processing\">User guide</a>中詳細瞭解。"

msgid ""
"Find out more in the\n"
"      <a c8y-guide-href=\"users-guide/administration/#managing-permissions\">User guide`KEEP_ORIGINAL`</a>."
msgstr ""
"在\n"
"      <a c8y-guide-href=\"users-guide/administration/#managing-permissions\">User guide</a>中詳細瞭解。"
...
msgid "First you have to upload the appropriate certificate by clicking \"Upload certificate\"."
msgstr "首先，您必須按一下 \"上傳證書\" 來上傳相應證書。"
...
msgstr "應包括以下必填欄位：{{fields}}"

msgid "Font"
msgstr "字體"

msgid ""
"For correct application behavior you can use only {{ vm.defaultRedirectUrl }} or\n"
"              {{ vm.host }} values, it is advised to use the first one."
msgstr ""
"要獲得正確的應用程式列為，您只能使用 {{ vm.defaultRedirectUrl }} 或\n"
"              {{ vm.host }} 值，建議使用第一個值。"
...
msgstr ""
"為了能夠識別預留位置，它至少需要在花括弧中使用一次，\n"
"且不帶其他運算式，例如 <var ng-non-bindable>{{ placeholderName }}</var>。然後，您可以在 Angular 處理的綁定中使用此 placeholderName。\n"
"還有預定義函數可用："
...
msgstr "獲取 PPPoE（受密碼保護）"

msgid "Get PROCCFG Database"
msgstr "獲取 PROCCFG 資料庫"

msgid "Get SCHEDULE Database"
msgstr "獲取 SCHEDULE 資料庫"
...
msgstr "獲取代理 modbus 埠"

msgid "Get agent modbus serial port"
msgstr "獲取代理 modbus 序列埠"
...
msgstr "歡迎使用 Cockpit 應用程式"

msgid "Get ledmode"
msgstr "獲取 ledmode"

msgid "Get ledmode (password protected)"
msgstr "獲取 ledmode（受密碼保護）"
...
msgstr "提供對批量操作和設備管理應用程式的訪問，但不包括對任何設備資料的訪問。"
...
msgstr "全域庫存許可權會取代庫存角色許可權。如果要限制庫存訪問，請僅通過庫存角色來授予。"
...
msgstr "已更新全域角色 \"{{name}}\"：{{updatesList}}"
...
msgstr "擁有所有已部署 CEP 模組和 SmartRules 的完全存取權限"
...
msgstr "這裡有一些能幫助您入門的資料點"

msgid "Hex, rgb or rgba value."
msgstr "十六進位、rgb 或 rgba 值。"

msgid "Hex, rgb or rgba value. Default: {{defaultColor}}"
msgstr "十六進位、rgb 或 rgba 值。預設值：{{defaultColor}}"
...
msgstr "ID \"{{deviceId}}\" 包含無效字元：\"{{invalidCharacter}}\"。"
...
msgstr "如果選中，則每個請求都需要使用與啟動會話的第一個請求相同的 \"User-Agent\" 標頭。"

msgid "If selected, you will be able to change assigned roles in Administration after user creation. Otherwise, roles will be synchronized with authorization server on each log in."
msgstr "如果選中，您將能夠在創建用戶後更改 Administration 中指派的角色。否則，角色將在每次登錄時與授權伺服器同步。"

msgid "If the filter is set, the firmware will show up for installation only for devices of that type. If no filter is set, it will be available for all devices."
msgstr "如果設置了篩選器，則韌體將僅針對該類型的設備顯示以進行安裝。如果未設置篩選器，則它將可用於所有設備。"
...
msgstr "如果設置了篩選器，則軟體將僅針對該類型的設備顯示以進行安裝。如果未設置篩選器，則它將可用於所有設備。"
...
msgstr "如果選取目前設置作為預設值，只要將此資料點添加到資料資源管理器或引用此資料點的現有閾值智慧規則，就將使用這些值。"

msgid "Image"
msgstr "圖像"

msgid "Image \"{{imageName}}\" pulled."
msgstr "已提取映射 \"{{imageName}}\"。"
...
msgstr "為了在設備詳細資訊中檢視“連線性”選項卡，使用者需要有“連線性”的“讀取”許可權。要更改 SIM 卡狀態和發送文字消息，使用者需要有“連線性”的“管理員”許可權。"
...
msgstr "安裝 Cumulocity IoT 感測器應用程式"
...
msgstr "已安裝的配置與設定檔中的 URL 相同，但名稱或類型不同"
...
msgstr "必須填寫國際電話號碼，格式為：+49 9 876 543 210。"
...
msgstr "電話號碼格式無效。僅允許數字、空格、斜線 (\"/\") 和短橫線 (\"-\")。"
...
msgstr "存活性檢測失敗：等待連接時，取消了 {{requestMethod}} {{uri}}: {{protocol}}: 請求（等待標題時超過 Client.Timeout 限制）。"
...
msgstr "從庫中載入 \"{{ kpi.c8y_Kpi.label }}\""
...
msgid "Maximum 120 characters allowed."
msgstr "最多允許 120 個字元。"
...
msgstr "可包含小寫字母、數字和連字號。必須以字母開頭；連字號只能在中間使用；至少 2 個字元。"
...
msgstr "消息 ID 在所有消息和回應範本中必須是唯一的。"
...
msgstr "消息範本識別字。識別字在所有消息和回應範本中必須是唯一的。"
...
msgstr "ID 為 \"{{templateId}}\" 的 SmartREST 範本中不存在 ID 為 \"{{messageId}}\" 的消息"
...
msgstr "必須將消息傳遞提供商配置為通過 SMS 將 WAN 設置發送到設備。"
...
msgstr "微服務應用程式名稱不正確：只允許小寫字母、數字和破折號。最大長度：{{maxLength}}。"
...
msgstr "正在將匯出計畫遷移到新使用者介面。在完成此進程之前，請勿關閉瀏覽器視窗。"
...
msgstr "必須為有效的十六進位數字（大寫字母）。"

msgid "Must be a valid hexadecimal number."
msgstr "必須是有效的十六進位數字。"

msgid "Must be a valid product certificate key, e.g. P_001F_EDCB_01"
msgstr "必須是有效的產品證書金鑰，例如 P_001F_EDCB_01"

msgid "Must be valid JSONPath expression."
msgstr "必須是有效的 JSONPath 運算式。"

msgid "Must have at least {{length}} characters"
msgstr "必須有至少 {{length}} 個字元"
...
msgid "Name, description and device type filter"
msgstr "名稱、說明和設備類型篩選器"
...
msgstr "從 #{source.name} 新增 #{severity} 警報"

msgid "New #{severity} alarm has been received from #{source.name}. Alarm text is: \"#{text}\"."
msgstr "已從 #{source.name} 收到新 #{severity} 警報。警報文字為：\"#{text}\"。"

msgid "New bulk operation"
msgstr "新批量操作"
...
msgstr "未找到 \"{{ searchData.lastText }}\" 的資產或設備。"
...
msgstr "自 {{timestamp | absoluteDate}} 之後，未與設備通信。"
...
msgid "No device protocols configured. Create a LoRa device protocol on the Device protocols page."
msgstr "未配置設備協定。在“設備協定”頁面上創建 LoRa 設備協定。"
...
msgstr "在上傳的 CSV 檔案案中未找到任何條目。"

msgid "No entries to display."
msgstr "沒有可供顯示的條目。"

msgid "No enum match for: {{ viewValue }}."
msgstr "以下項沒有枚舉匹配項：{{ viewValue }}。"

msgid "No escalation steps defined."
msgstr "未定義升級步驟。"

msgid "No event processing rules found."
msgstr "未找到事件處理規則。"
...
msgid "No firmware defined. Add firmware"
msgstr "未定義固件。添加固件"
...
msgstr "在 {{dateFrom | absoluteDateTimeFormat:'LL, LTS':'+0000'}} 後無日誌可用。"

msgid "No logs available before {{dateTo | absoluteDateTimeFormat:'LL, LTS':'+0000'}}."
msgstr "在 {{dateTo | absoluteDateTimeFormat:'LL, LTS':'+0000'}} 前無日誌可用。"
...
msgstr "時間範圍 {{dateFrom | absoluteDateTimeFormat:'LL, LTS':'+0000'}} - {{dateTo | absoluteDateTimeFormat:'LL, LTS':'+0000'}} 中沒有日誌可用。"
...
msgstr "未找到匹配項。請優化您的搜尋詞或檢查您的拼寫。"

msgid "No matching devices."
msgstr "無匹配設備。"

msgid "No matching managed objects."
msgstr "沒有匹配的託管物件。"
...
msgstr "沒有與所有 predicate 匹配的節點：[{{predicates}}]。"
...
msgstr "無預覽可用於 <code>text/*</code> 之外的 MIME 類型的日誌檔案。"
...
msgstr "不足夠被定義的屬性，最少 {{ schema.minProperties }}"
...
msgstr "注意，匯出資料比較耗時，匯出完成後，將發送電子郵件通知。"
...
msgstr "請注意，此規則可以使用資料點庫中的配置，也可以使用資料點配置。創建規則後更改資料點配置可能會導致規則故障。考慮改用規則 \"在測量達到顯式閾值時創建警報\"。"

msgid "Note: Report generation can take a long time to complete."
msgstr "注意：可能需要較長時間才能完成報告生成。"

msgid "Note: Sorting might not work properly until all rows are loaded."
msgstr "注意：可能需要載入所有行，才能進行正常排序。"

msgid "Note: You may need to restart your device to actually apply new settings."
msgstr "注意：您可能需要重新開機設備才能實際應用新設置。"
...
msgstr "截至 {{end}}的根設備的數量。不包括子設備。"

msgid "Number of root devices, excluding child devices"
msgstr "根設備的數量，不包括子設備。"

msgid "OAuth"
msgstr "OAuth"

msgid "OAuth access token type"
msgstr "OAuth 授權 access token 類型"

msgid "OAuth token URL"
msgstr "OAuth token 網址"

msgid "OAuth token mime type"
msgstr "OAuth access token MIME 類型"
...
msgstr "您授予許可權的物件的片段類型（例如 c8y_IsDevice）。請注意，要訪問物件，使用者必須能夠訪問其所有片段。使用星號 (*) 可以為任何物件的片段類型授予許可權。"

msgid "Objects"
msgstr "物件"

msgid "Observe sensor value. Causes device to send every new sensor value"
msgstr "觀察感測器值。導致設備發送每個新的感測器值"
...
msgstr "按計劃通過電子郵件發送匯出"

msgid "On step {{stepNo}} failed"
msgstr "在第 {{stepNo}} 步失敗"
...
msgstr "按計時器通過電子郵件發送儀錶板"

msgid "On timer send export via email"
msgstr "按計時器通過電子郵件發送匯出"
...
"            smartphone."
msgstr ""
"開啟您智慧型手機上的 <strong>Google Play Store</strong>\n"
...
msgstr "操作 \"{{ description | translate }}\" 失敗：\"{{ failureReason | translate }}\"。"

msgid "Operation \"{{ description | translate }}\" succeeded."
msgstr "操作 \"{{ description | translate }}\" 成功。"

msgid "Operation \"{{ description | translate }}\" will be executed."
msgstr "將執行操作 \"{{ description | translate }}\"。"
...
msgstr "覆蓋 OAuth access token 類型"

msgid "Overrides the OAuth token response mime type"
msgstr "覆蓋 OAuth token 回應 MIME 類型"
...
msgstr "密碼無效。它必須至少有 {{minCharactersCount}} 個字元且不得超過 {{maxCharactersCount}} 個字元。"
...
msgstr "密碼必須有至少 8 個字元，不得超過 32 個字元，並且只能包含字母、數字和以下符號：`~!@#$%^&*()_|+-=?;:'\",.<>{}[]\\/"

msgid "Password must have at least 8 characters and no more than 32."
msgstr "密碼必須有至少 8 個字元，不得超過 32 個字元。"
...
msgstr "密碼必須有至少 {{min}} 個字元，不得超過 {{max}} 個字元，並且只能包含字母、數字和以下符號：`~!@#$%^&*()_|+-=?;:'\",.<>{}[]\\/"

msgid "Password not good enough, password must be stronger (green)."
msgstr "密碼不夠好，密碼必須更強（綠色）。"
...
msgid ""
"Path for binaries can vary depending on device agent implementation, e.g.:\n"
"    /firmware/binaries/firmware1.bin\n"
"    https://firmware/binary/123\n"
"    ftp://firmware/binary/123.tar.gz"
msgstr ""
"二進位檔案路徑可能會因設備代理實施而異，例如：\n"
"    /firmware/binaries/firmware1.bin\n"
"    https://firmware/binary/123\n"
"    ftp://firmware/binary/123.tar.gz"
...
msgstr "預留位置：{tenant} - 已暫停租戶的 ID；{tenant-domain} - 租戶的域"

msgid "Placeholder: {token} - created token"
msgstr "預留位置：{token} - 已創建權杖"

msgid "Placeholders: {host}, {tenant-domain}"
msgstr "預留位置：{host}、{tenant-domain}"

msgid "Placeholders: {tenant-domain}, {host}, {binaryId}. Whole link to result file is: {tenant-domain}/inventory/binaries/{binaryId}"
msgstr "預留位置：{tenant-domain}、{host}、{binaryId}。結果檔案的完整連結為：{tenant-domain}/inventory/binaries/{binaryId}"
...
msgstr "預留位置：{tenant-domain}、{host}、{token}、{email}。例如，重置密碼的完整連結可以是：{tenant-domain}/apps/devicemanagement/index.html?token={token}&email={email}"
...
msgstr "預留位置：{tenant-domain}、{host}、{token}。例如，設置密碼的完整連結可以是：{tenant-domain}/apps/devicemanagement/index.html?token={token}"

msgid "Placeholders: {user}, {exportApi}"
msgstr "預留位置：{user}、{exportApi}"

msgid "Platform application cannot be added to, nor removed from any tenant."
msgstr "平臺應用程式無法添加到任何租戶，也無法從任何租戶移除。"

msgid "Please contact your platform administrator."
msgstr "請聯繫平臺管理員。"

msgid "Please meet 5 out of the 5 conditions below"
msgstr "請符合以下 5 個條件中的 5 個條件"
...
msgstr ""
"應用程式附帶的外掛程式。這些外掛程式是運行應用程式所必需的，\n"
"          不能移除。"

msgid "Pod \"{{imageName}}\" created."
msgstr "已創建 Pod \"{{imageName}}\"。"

msgid "Pod \"{{imageName}}\" deleted."
msgstr "Pod \"{{imageName}}\" 已刪除。"
...
msgstr "選取 \"公開金鑰/私密金鑰\" 選項時，必須提供私密金鑰。"
...
msgstr "查詢模擬輸入 Hutline"

msgid "Query Eifeler Vacotec server port"
msgstr "查詢 Eifeler Vacotec 伺服器埠"
...
msgid "Range start and end values must not be equal."
msgstr "範圍開始值和結束值不能相等。"
...
msgstr "就緒性檢測失敗：等待連接時，取消了 {{requestMethod}} {{uri}}: {{protocol}}: 請求（等待標題時超過 Client.Timeout 限制）。"
...
msgstr "即時事件處理目前超載，可能會停止處理您的事件。請聯繫支援人員。"
...
msgstr "需要重定向到正確的域才能以支持用戶身份登錄。"

msgid "Redirect to…"
msgstr "重定向至…"

msgid "Refer to a resource using the following format: /Object/Instance/Resource, e.g. /3303/0/5700."
msgstr "請參閱使用以下格式的資源：/物件/實例/資源，如 /3303/0/5700。"
...
msgid "Refine or clear the filters."
msgstr "優化或清除篩選器。"
...
msgstr[0] "總共 {{total}} 個設備中，有 {{$count}} 個設備註冊失敗。"
...
msgstr "請替換證書。確保上傳具有適當常用名的有效 SSL 萬用字元證書。已禁用對此證書的啟動。"
...
msgstr "複本集 \"{{replicaSetName}}\" 縮減到 \"{{scaleNumber}}\"。"

msgid "Replica set \"{{replicaSetName}}\" scaled up to \"{{scaleNumber}}\"."
msgstr "複本集 \"{{replicaSetName}}\" 擴展到 \"{{scaleNumber}}\"。"
...
msgstr "SSH clearkeys（受密碼保護）"

msgid "SSH genkeys"
msgstr "SSH genkeys"

msgid "SSH genkeys (password protected)"
msgstr "SSH genkeys（受密碼保護）"
...
msgstr "使用智慧型手機通過 Google Authenticator 應用程式掃描此二維碼。"
...
msgstr "選取上述 API 和方法以檢視所需的 API 值。"
...
msgstr "選取是否以基於 8 位值的小端格式表示值（如果 &#34位數&#34 大於 8，則可以選取此選項）。"
...
msgstr "選定的單位轉換將用於顯示資料。選取 \"無轉換\" 可檢視設備發送的原始單位。"
...
msgstr "選取引用伺服器允許您根據 OPC UA 伺服器上存儲的 OPC UA 模型創建設備類型。這將大幅簡化映射流程，因為可以根據將在伺服器上實際存在的 OPC UA 瀏覽路徑創建設備類型。"

msgid "Selecting a reference server requires selecting a reference node."
msgstr "選取參考伺服器需要選取參考節點。"

msgid "Selecting the \"All objects\" option will synchronize all types of objects, including internal and technical ones (not exclusively groups and devices). This may cause issues on the target tenant."
msgstr "選取 \"所有物件\" 選項將同步所有類型的物件，包括內建物件和技術物件（不僅僅限於組和設備）。這可能會導致目標租戶出現問題。"
...
msgstr "將配置類型 {{configurationType}} 的配置快照 {{snapshotName}} 發送到設備 {{deviceName}}"

msgid "Send configuration snapshot {{snapshotName}} to device {{deviceName}}"
msgstr "將配置快照 {{snapshotName}} 發送到設備 {{deviceName}}"
...
msgstr "用於所發送 SMS 的寄件者地址"

msgid "Sender name"
msgstr "寄件者名稱"

msgid "Sender name used for sent SMS"
msgstr "用於所發送 SMS 的寄件者名稱"
...
msgstr "設置 PPPoE（受密碼保護）"

msgid "Set Profibus configuration"
msgstr "設置 Profibus 配置"
...
msgstr "設置代理 GPIO 間隔（秒）"

msgid "Set agent GPS interval (in seconds)"
msgstr "設置代理 GPS 間隔（秒）"
...
msgstr "設置代理 modbus 埠"

msgid "Set agent modbus serial port"
msgstr "設置代理 modbus 序列埠"
...
msgstr "設置日誌級別（\"debug\"、\"info\"、\"notice\"、\"warning\"、\"error\"、\"critical\"）"

msgid "Set log quota (in KB)"
msgstr "設置日誌配額 (KB)"

msgid "Set manually bulk operation to SUCCESSFUL"
msgstr "手動將批量操作設置為“成功”"
...
msgid "Show devices with active`alarms`"
msgstr "顯示具有以下活動項的設備："
...
msgid "Show target child devices"
msgstr "顯示目標子設備"
...
msgstr ""
"指定自動應用約束允許您限制\n"
"設備協定的應用範圍，例如通過指定一組可能的伺服器或節點 ID。"
...
msgstr "首先上傳 DDF 或 XML 檔案"

msgid "Start date"
msgstr "開始日期"

msgid "Start typing to search, e.g. {{ example }}"
msgstr "開始鍵入以搜尋，例如 {{ example }}"
...
msgstr "{{name}} 的狀態已更改為 {{label}}"

msgid "Status of {{name}} will be changed to {{label}}"
msgstr "{{name}} 的狀態將更改為 {{label}}"
...
msgstr "設備屬性工作表，例如名稱、類型或備註。"

msgid "Take your phone and click <strong>Next</strong>."
msgstr "拿起手機並按一下<strong>下一步</strong>。"

msgid "Takes a value between -32768 and 32767 minutes (a negative value indicates that the device is under maintenance)."
msgstr "採用 -32768 和 32767 分鐘之間的值（負值表示設備正在維護）。"
...
msgstr "目標 URL {{targetUrl}} 已被另一個連接器使用。"
...
msgstr "已更新租戶 \"{{tenant}}\"：{{properties}}。"
...
msgstr ""
"“允許的域”允許您的 JavaScript Web 應用程式直接與 REST API 通信。\n"
"\n"
"選項：\n"
"- 輸入 \"*\" 以允許來自任何主機的通信，\n"
"- 輸入 \"http://my.host.com, http://myother.host.com\" 以允許來自 http://my.host.com 和 http://myother.host.com 的應用程式與平台通信，\n"
"-將欄位留空以僅允許從租戶域訪問。\n"
"\n"
"有關更多資訊，請檢查 <a target=\"_blank\" rel=\"noopener noreferrer\" href=\"https://enable-cors.org\">enable-cors.org</a>"

msgid "The Actility ThingPark URL may differ depending on the type of the account being used (e.g. Community or Enterprise edition). This is an optional field, if nothing is entered here, the default setting is taken from the agent."
msgstr "Actility ThingPark URL 可能會因所使用的帳戶類型（例如社區版或企業版）而異。這是一個可選欄位；如果未在此處輸入任何內容，則從代理中獲取預設設置。"
...
msgstr ""
"通過 Cockpit 應用程式，您可以在數分鐘內構建 IoT 應用程式。\n"
"要開始使用，請將任何設備連接到平臺。\n"
"如果您沒有 IoT 設備，則可以通過連接智慧型手機來開始。\n"
"按一下下面可在整個過程中得到指導。"
...
msgstr "URL 格式無效。僅支援 http、https 和 opc.tcp 協定。"
...
msgstr "任何其他租戶均未使用常用名稱（域名）"

msgid "The content couldn't be loaded."
msgstr "無法載入內容。"

msgid "The dashboard is styled with a dark background and has high contrast."
msgstr "儀錶板的背景樣式為深色且對比度高。"

msgid "The dashboard is styled with a light background and has low contrast."
msgstr "儀錶板的背景樣式較淺，對比度較低。"

msgid "The dashboard is styled with a transparent background and therefore is border-less."
msgstr "儀錶板具有透明背景樣式，因此沒有邊界。"

msgid "The dashboard is styled with the main brand color."
msgstr "儀錶板的樣式採用主要品牌色彩。"

msgid "The default application specifies the application that shows up per default when logging into the platform. It applies to all users of the tenant. Select an application from the list below and make sure that all users can access this application."
msgstr "預設應用程式指定登錄平台時預設顯示的應用程式。它適用于租戶的所有用戶。從下面的清單中選取應用程式，並確保所有用戶都可以訪問此應用程式。"
...
msgstr ""
"外部 ID 用於連結設備資訊和物理環境（例如：序號、IMEI）。\n"
"\n"
"如因某些原因需更換硬體，還必須用適當的資訊替換外部 ID。\n"
"\n"
"通過此程式，新硬體可繼續連結到其前身創建的資訊。"
...
msgstr "最大時間段屬性指示 LWM2M 使用者端可能在兩個通知之間等待的最長時間（秒）。"
...
msgstr "安全密碼所需的最少字元數。最小（和預設）值為 8，最大值為 32。留空可跳過此約束。"
...
msgstr "最小時間段屬性指示 LWM2M 使用者端必須在兩個通知之間等待的最短時間（秒）。"
...
msgstr "密碼必須重置前的有效天數；最小值為 0，最大值為 999999。留空可使用租戶選項中的值。"

msgid "The number of times before the current password can be reused. Minimum value is 0, preset value is 10."
msgstr "可以重複使用目前密碼之前的次數。最小值為 0，預設值為 10。"

msgid "The operation may take several minutes. During this time the application may be unavailable. Do you want to proceed?"
msgstr "此操作可能需要幾分鐘。在此時間段內，應用程式可能不可用。是否要繼續？"

msgid "The quota calculation is based on the known number of devices, as displayed below."
msgstr "配額計算基於已知設備數量，如下所示。"
...
msgstr "值必須大於\"權杖使用壽命\"且不小於 {{ minAbsoluteTimeout }}。"

msgid "The value must be less than \"Session absolute timeout\"."
msgstr "值必須小於 \"Session absolute timeout\"。"
...
msgid "There are no credentials provided yet.<br>Please provide some."
msgstr "尚未提供任何憑據。<br>請提供一些。"
...
msgstr "需要這些 Cookie 才能啟用核心網站功能。它們將執行一項任務或操作，沒有這些任務或操作將無法執行網站的功能。"

msgid "These cookies are used to target advertising to a user."
msgstr "這些 Cookie 用於向用戶定向投放廣告。"
...
msgstr "此應用程式是從 \"{{name}}\" 複製過來，不會從它獲取任何進一步更新。"

msgid "This dashboard is shared between all devices of the type <i>{{ type }}</i>."
msgstr "此儀錶板將在類型為 <i>{{ type }}</i> 的所有設備之間共用。"

msgid "This date is invalid."
msgstr "日期無效。"

msgid "This device has just been deleted. You will be redirected to \"All devices\" page now."
msgstr "此設備剛被刪除。您現在將被重定向到 \"所有設備\" 頁面。"
...
msgstr ""
"此功能已棄用。雖然這仍完全可正常運行，但應改用 \n"
"    <a href=\"/apps/administration#roles\">角色</a>設置許可權。"
...
msgstr "此功能已棄用。儘管此功能仍能完全正常運行，您應使用新的<a href=\"/apps/administration#roles\">角色</a>功能來設置許可權。"
...
msgstr "這是權杖中欄位的名稱，其值將用於選取以下具有匹配的 \"證書 ID 值\" 的證書之一。"
...
msgstr "此登錄模式已由另一位元管理員設置。請刷新頁面以更新資料。"
...
msgstr ""
"此使用者指派有含 \"應用程式管理\" 許可權的全域角色。因此，所有\n"
"            應用程式都可訪問。"

msgid "This widget cannot be rendered because the current application does not support the following component:"
msgstr "由於目前應用程式不支援以下元件，因此無法呈現此小組件："

msgid "This will apply to data coming from specified device"
msgstr "這將應用於從指定設備接收的資料"
...
msgstr "這將與根據 \"源\" 設置從協定資料中提取的消息 ID 相匹配。"
...
msgstr "要更改整個應用程式的語言，我們建議您重新載入頁面。如果您有任何未儲存的更改，您可以稍後重新載入。您要做什麼？"
...
msgstr "要更改整個應用程式的跟蹤選項，我們建議您重新載入頁面。如果您有任何未儲存的更改，您可以稍後重新載入。您要做什麼？"

msgid "To see the result click <a href=\"#/device/{{deviceId}}/control\">here</a>"
msgstr "要檢視結果，請按一下<a href=\"#/device/{{deviceId}}/control\">此處</a>"
...
msgstr "太多屬性被定義，最多 {{ schema.maxProperties }}。"
...
msgstr "跟蹤器現正等待連接，連接到伺服器後，請在 \"正在等待跟蹤器註冊\" 視窗中完成註冊。"
...
msgid "URL where the OAuth token is requested from (required if OAuth method is chosen)"
msgstr "從中請求 OAuth token 的 URL（選取 OAuth 方法時需要）"

msgid "USER"
msgstr "使用者"

msgid "Unable to find option by given key: sigfox-agent/provider.token"
msgstr "無法通過給定金鑰找到選項：sigfox-agent/provider.token"

msgid "Unable to get system option: \"{{option}}\"."
msgstr "不能獲取系統選項：\"{{option}}\"。"

msgid "Unable to get tenant option: \"{{option}}\"."
msgstr "不能獲取租戶選項：\"{{option}}\"。"

msgid "Unassign"
msgstr "取消指派"

msgid "Unassign asset"
msgstr "取消指派資產"
...
msgstr ""
"不支援的跟蹤器型號 \"{{ tracker.device.c8y_Hardware.model }}\"。\n"
"從下面的清單中選取受支援的模型之一。"
...
msgstr "已更新 \"{{parentDeviceName}}\"（ID：{{parentDeviceId}}）的子設備。"
...
msgstr "上傳包含私密金鑰和證書的 PKCS #12 (.pk12) 檔案。"
...
msgstr "上傳 {{ vm.wizardCtrl.data.chosenMethod.expectedExtension }} 檔案"
...
msgstr "本月迄今為止的使用情況 ({{thisMonthStart}} - {{thisMonthEnd}})"
...
msgstr "已更新使用者 \"{{name}}\"：{{updatesList}}"

msgid "User \"{{userName}}\" deleted."
msgstr "已刪除使用者 \"{{userName}}\"。"
...
msgstr "使用者 \"{{userName}}\" 由管理員定義的遠端標識管理服務管理，禁止直接更新。"
...
msgstr "在 Cockpit 應用程式中工作的使用者。不包括對任何設備資料的訪問。"
...
msgstr "{{name}} 值已更改為 {{value}}{{unit}}"

msgid "Value of {{name}} will be changed to {{value}}{{unit}}"
msgstr "{{name}} 值將更改為 {{value}}{{unit}}"
...
msgstr "版本：{{ vm.backendVersion }}（後端），{{ vm.uiVersion }} (UI)"
...
msgid "Wait while groups for current tenant are loaded…"
msgstr "請等待，正在載入目前租戶的群組…"

msgid "Wait while provider settings are loaded…"
msgstr "正在載入供應商設置，請稍候…"
...
msgstr[0] "我們現將您註銷並在 <b>{{$count}}</b> 秒內重定向到您的新域 {{vm.redirectUrl}}。"
...
msgstr "每週：{{ weekDay }}，{{ hour }}:{{ minutes }}。"
...
msgstr "處於活動狀態時，網關會掃描所有伺服器的地址空間，並自動將此設備協定應用於所有符合標準的節點。"
...
msgstr "按一下“確定”即表示您同意支援使用者可以訪問您的租戶，以幫助您解決特定問題。"
...
msgstr ""
"您已將 CNAME 條目添加到 DNS 伺服器。確保移除\n"
"                萬用字元域的所有 A 條目。如果 DNS 服務未提供萬用字元\n"
"                證書的 CNAME 條目，請聯繫支援人員"
...
msgstr "您將要刪除 IMPACT 認證。刪除認證將中斷與 IMPACT 實例的連接。是否要繼續？"

msgid "You are about to download file \"{{ fileName }}\". Do you want to proceed?"
msgstr "您即將下載檔案 \"{{ fileName }}\"。是否要繼續？"
...
msgstr ""
"您即將移除應用的品牌。\n"
"        如果您設置了任何額外的自訂選項，它們將被重置。\n"
"        預設品牌將顯示給所有子租戶。是否要繼續？"

msgid "You are about to remove plugins from application \"{{ humanizedAppName }}\". The operation may take several minutes. During this time the application may be unavailable. Do you want to proceed?"
msgstr "您即將從應用程式 \"{{ humanizedAppName }}\" 中移除外掛程式。此操作可能需要幾分鐘。在此時間段捏，應用程式可能不可用。是否要繼續？"
...
msgid "You can enter a set of LWM2M shell commands. Each of them will be sent to every newly registered LWM2M device."
msgstr "您可以輸入一組 LWM2M Shell 命令。其中每個命令都將被發送到每個新註冊的 LWM2M 設備。"

msgid "You can provide some examples displayed as placeholder…"
msgstr "您可以提供一些顯示為預留位置的示例…"

msgid "You can use the following variables in your HTML code:"
msgstr "您可以在 HTML 代碼中使用以下變數："

msgid "You cannot edit global roles for user with external origin, since it is managed via your authorization server."
msgstr "您不能為具有外部來源的用戶編輯全域角色，因為它是通過您的授權伺服器進行管理的。"
...
msgstr "您沒有管理 {{ user.userName }} 的應用程式訪問權限所需的許可權。"

msgid "You don't have the permission required to manage inventory roles for {{ vm.user }}."
msgstr "您沒有管理 {{ vm.user }} 的庫存角色所需的許可權。"

msgid "You don't have the permission required to schedule exports."
msgstr "您沒有計劃匯出所需的許可權。"

msgid "You don’t have the permission required to edit this rule."
msgstr "您沒有編輯此規則所需的許可權。"
...
msgstr "您需要以下角色來訪問保留規則：保留規則讀取/管理員"

msgid "You need this role to access simulators: Simulator Admin."
msgstr "您需要此角色來訪問模擬器：模擬器管理員。"

msgid "You need to fix validation errors before you can save."
msgstr "您需要先行修復驗證錯誤，才能儲存。"

msgid "You need to select a device and fill all mappings to be able to preview an SVG."
msgstr "您需要選取一個設備並填充所有映射才能預覽 SVG。"

msgid "You reached devices limit. No more devices can be registered."
msgstr "您已達到設備數量上限。無法註冊更多設備。"

msgid "You reached the limit of {{ vm.limitStatus.limit }} devices. No more devices can be registered."
msgstr "您已達到 {{ vm.limitStatus.limit }} 個設備的限制。無法註冊更多設備。"

msgid "You removed delegation from user \"{{userName}}\"."
msgstr "您已移除對使用者 \"{{userName}}\" 的授權。"

msgid "You uploaded a valid SSL certificate for your custom domain"
msgstr "您已為自訂域名上傳有效的 SSL 證書"

msgid "You will be logged out to apply your new password. Do you want to proceed?"
msgstr "您將被登出以應用您的新密碼。是否要繼續？"
...
msgstr "[{{id}}] - 缺少 AccessType、無效或不受支援"

msgid "[{{id}}] - missing, invalid or unsupported DataType"
msgstr "[{{id}}] - DataType 缺失、無效或不受支援"
...
msgstr "已添加應用程式 [{{applicationsList}}]"

msgid "applications [{{applicationsList}}] removed"
msgstr "已移除 [{{applicationsList}}] 應用程式"
...
msgstr "刪除 \"{{ softwareName }}\""

msgid "delete \"{{ softwareName }}\" (version: {{ softwareVersion }})"
msgstr "刪除 \"{{ softwareName }}\"（版本：{{ softwareVersion }}）"

msgid "description: \"{{ description | translate }}\""
msgstr "說明：\"{{ description | translate }}\""

msgid "device name"
msgstr "設備名稱"

msgid "device name: \"{{ deviceName }}\""
msgstr "設備名稱：\"{{ deviceName }}\""
...
msgstr "例如 10300，您可以使用星號 (*) 作為萬用字元"

msgid "e.g. 46543432321"
msgstr "例如 46543432321"

msgid "e.g. 46543432321, you can use an asterisk (*) as wildcard character"
msgstr "例如 46543432321，您可以使用星號 (*) 作為萬用字元"

msgid "e.g. 54321-123"
msgstr "例如 54321-123"

msgid "e.g. 54321-123, you can use an asterisk (*) as wildcard character"
msgstr "例如 54321-123，您可以使用星號 (*) 作為萬用字元"

msgid "e.g. Application to manage devices"
msgstr "例如“用於管理設備的應用程式”"

msgid "e.g. Cloud connectivity"
msgstr "例如雲連接"
...
msgstr "例如應用於類型為 c8y_Linux 的設備的雲連接軟體"
...
msgstr "例如應用於類型為 c8y_Linux 的設備的設備設定檔"

msgid "e.g. Device profile for c8y_Linux devices"
msgstr "例如 c8y_Linux 設備的設備設定檔"
...
msgstr "例如應用於類型為 c8y_Linux 的設備的主機配置"

msgid "e.g. Host configuration c8y_Linux"
msgstr "例如主機配置 c8y_Linux"
...
msgstr "例如，joe 或 joe.doe@example.com"
...
msgstr "例如 value，您可以使用星號 (*) 作為萬用字元"
...
msgstr "pdpcycle（受密碼保護）"

msgid "pdpdown"
msgstr "pdpdown"

msgid "pdpdown (password protected)"
msgstr "pdpdown（受密碼保護）"
...
msgstr "正在搜尋 \"{{ searchHint }}\""

msgid "searching \"{{expression}}\""
msgstr "正在搜尋 \"{{expression}}\""
...
msgstr "{{ bulkOperationsCountFailed }} 失敗"
...
msgid "{{ deviceCount }} devices selected"
msgstr "已選取 {{ deviceCount }} 個設備"

msgid "{{ filteredItemsCount }} of {{ allItemsCount }} items"
msgstr "{{ filteredItemsCount }}/{{ allItemsCount }} 個項目"
...
msgstr ""
"{{protocolName | translate}} 設備可以發送不同類型的消息，每種類型的編碼不同。\n"
"      通過檢視\n"
"      消息的 FPort 參數（<b>源</b>：<i>FPort</i>）\n"
"      或消息有效負載（<b>源</b>：<i>有效負載</i>）本身的子集可確定類型。\n"
"      用於指示類型資訊在有效負載中的起始位置（<b>起始位</b>）\n"
"      以及此資訊的長度（<b>位數</b>）。"
...
msgstr ""
"{{protocolName | translate}} 設備可以發送不同類型的消息，每種類型的編碼不同。\n"
"通過檢視消息的 FPort 參數（<b>源</b>：<i>FPort</i>）可確定類型。"
...
msgstr ""
"{{protocolName | translate}} 設備可以發送不同類型的消息，每種類型的編碼不同。\n"
"通過檢視消息有效負載（<b>源</b>：<i>有效負載</i>）的子集可確定類型。\n"
"用於指示類型資訊在有效負載中的起始位置（<b>起始位</b>）\n"
"以及此資訊的長度（<b>位數</b>）。"
...
msgstr "{{status | translate}} 使用代碼 {{code}}"

msgid "{{storageLimit}} storage quota"
msgstr "{{storageLimit}} 存儲配額"

msgid "{{storageSize}} storage"
msgstr "{{storageSize}} 存儲空間"

msgid "{{vm.getFeatures().label}} device type"
msgstr "{{vm.getFeatures().label}} 設備類型"
