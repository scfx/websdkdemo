<div ng-controller="alarmListCtrl as vm">
  <c8y-ui-action-bar-set>
    <li class="btn-group d-flex" action-bar-position="left">
      <button
        title="{{ severity.name | lowercase | humanize | translate }}"
        ng-repeat="severity in vm.severities"
        type="button"
        class="btn btn-default d-flex a-i-center"
      ...
      >
        ...
        ></i>
        <span class="hidden-md hidden-sm text-truncate m-r-4" ng-bind="severity.name | lowercase | humanize | translate"></span>
    ...
    <li title="{{ 'Show cleared alarms' | translate }}" class="navbar-form">
      <label class="c8y-switch">
        ...
        />
        <span></span>
        <span title="{{'Show cleared alarms' | translate}}" 
          class="text-truncate"
        >
