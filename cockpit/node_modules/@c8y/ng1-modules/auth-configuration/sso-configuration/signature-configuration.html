<ng-form name="vm.ssoSignatureVerificationForm" class="col-md-12 p-t-16">
    ...
    <div class="col-xs-12 col-sm-9 col-md-10 col-lg-9">
      <div class="row">
        <div class="col-sm-6">
          ...
          >
            <div class="row">
              <div class="col-sm-6">
                <label class="control-label" translate> Verifier </label>
                <ui-select
                  class="form-control"
                ...
                >
                  ...
                  >
                    <div>
                      <span
                        title="{{ ct.label | translate }}"
                        ng-bind="ct.label | translate"
                      ></span>
                    </div>
                  </ui-select-choices>
                </ui-select>
          ...
          <div class="col-sm-6">
            <div class="form-group">
              ...
              <input
                ...
                class="form-control"
                required
                placeholder="{{ 'e.g.' | translate }} https://adfs.tenant.com/federationmetadata/federationmetadata.xml"
          ...
          <div class="col-sm-6">
            <div class="form-group">
              ...
              <input
                ...
                class="form-control"
                required
                placeholder="{{ 'e.g.' | translate }} https://login.microsoftonline.de/tenant/discovery/keys"
      ...
      <div id="manual" ng-if="vm.certificateTypeChosen === vm.certificateTypes.CUSTOM">
        ...
        <div>
          ...
          <div
            ng-if="
              vm.customCertificates.length > 1 &&
          ...
          >
            <div class="row">
              <div class="col-sm-6" ng-if="vm.customCertificates.length < 2">
                <div class="form-group">
              ...
              <div class="col-sm-6" ng-if="vm.customCertificates.length > 1">
                <div class="form-group">
                  <label class="control-label">
                  ...
                  <c8y-error-feedback
                    field="customCertificateForm.certificateKey"
                  ></c8y-error-feedback>
                </div>
              </div>
              <div class="col-sm-6" ng-if="vm.customCertificates.length > 1">
            ...
            <div class="separator-top p-b-24" ng-if="vm.customCertificates.length > 1"></div>
          </ng-form>
          <a
