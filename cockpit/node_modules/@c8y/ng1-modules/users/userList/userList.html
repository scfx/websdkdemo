    ...
    <div class="row">
      <div class="col-sm-10 p-r-0">
        <c8y-item-selector
          ...
          text-placeholder="{{ '----' }}"
          ng-disabled="vm.shouldDisableGlobalRolesSelector(user)"
        >
        </c8y-item-selector>
      </div>
      <div class="col-sm-1 p-l-4">
        <button
          class="btn btn-clean text-info"
          ng-if="vm.hasExternalOrigin(user) && !vm.mapRolesOnlyForNewUser"
          popover-trigger="'focus'"
          popover-append-to-body="true"
          popover-placement="right"
          uib-popover-html="vm.editGlobalRolesForUserWithExternalOrigin | translate"
        >
