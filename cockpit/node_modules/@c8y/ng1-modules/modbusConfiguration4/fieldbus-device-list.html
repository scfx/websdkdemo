<div ng-if="vm.shouldShowSection()">
  <div class="row">
      ...
      <div class="card m-b-4">
        ...
        <div class="card-block">
          <div class="c8y-list__group">
            <div class="c8y-list__item hidden-xs hidden-sm" ng-if="filtered.length > 0">
              <div class="c8y-list__item__block">
                <div class="c8y-list__item__body">
                  <div class="content-flex-60">
                    <div class="col-3" ng-if="vm.mode !== 'CAN'">
                    ...
                    <div class="col-2" ng-if="vm.mode ==='CANopen'">
                      <label class="small" translate>Node ID</label>
                    </div>
                    <div class="col-3" ng-if="vm.mode === 'TCP'">
            ...
            >
              <div class="c8y-list__item__block">
                ...
                <div class="c8y-list__item__actions showOnHover">
                  <button
                    class="btn btn-link"
            ...
            <!-- empty state -->
            <div class="card bg-gray-white">
              <c8y-ui-empty-state
                data-title="'No devices found.' | translate"
                subtitle="'Add a device by clicking on the button below.' | translate"
            ...
            <div class="row">
                ...
                >
                  ...
                  <c8y-messages>
                    <c8y-message
                      ...
                      ng-if="vm.invalid('address')"
                    >
                      {{ vm.getFieldValidationHints('address') }}
                    </c8y-message>
                  </c8y-messages>
                </div>
              </div>
              <div class="col-md-6">
                ...
                >
                  ...
                  />
                  <c8y-messages>
                    <c8y-message class="form-control-feedback-message" ng-if="vm.invalid('nodeId')">
                      {{ vm.getFieldValidationHints('nodeId') }}
                    </c8y-message>
                  </c8y-messages>
                </div>
                <div
...
<div ng-if="vm.isSNMPTab()" class="row">
  <div class="col-lg-12 col-lg-max">
    <div class="card">
      ...
      <div class="card-block">
            ...
            <div ng-class="{'expanded': isDetailExpanded}">
              <div class="c8y-list__item__block">
                ...
                <div class="c8y-list__item__actions">
                  <button
                    class="btn-clean text-danger showOnHover"
                    title="{{ 'Remove' | translate }}"
                    ng-click="vm.onClickDelete(device)"
                  >
                    <i c8y-icon="minus-circle" class="text-danger"></i>
                        ...
                        <div class="col-sm-6">
                          ...
                          >
                            ...
                            <c8y-messages>
                              <c8y-message
                                class="form-control-feedback-message"
                                ng-if="vm.invalid('snmpVersionUsername',vm.getDeviceFormName(editDevice))"
                              >
                                {{
                                  vm.getFieldValidationHints(
                                    'snmpVersionUsername',
                        ...
                        <div class="col-sm-6">
                          ...
                          >
                            ...
                            <c8y-messages>
                              <c8y-message
                                class="form-control-feedback-message"
                                ng-if="vm.invalid('snmpVersionSecurityLevel', vm.getDeviceFormName(editDevice))"
                              >
                                {{ vm.getFieldValidationHints('snmpVersionSecurityLevel', vm.getDeviceFormName(editDevice)) }}
                              </c8y-message>
                            </c8y-messages>
                          </div>
                        </div>
                        ...
                        <div class="col-sm-6">
                          ...
                          >
                            ...
                            <c8y-messages>
                              <c8y-message
                                class="form-control-feedback-message"
                                ng-if="vm.invalid('snmpVersionEngineId',vm.getDeviceFormName(editDevice))"
                              >
                                {{ vm.getFieldValidationHints( 'snmpVersionEngineId', vm.getDeviceFormName(editDevice)) }}
                              </c8y-message>
                            </c8y-messages>
                          </div>
                        </div>
                          ...
                          <div class="col-sm-6">
                            ...
                            >
                              ...
                              <c8y-messages>
                                <c8y-message
                                  class="form-control-feedback-message"
                                  ng-if="vm.invalid('snmpVersionAuthProtocol',vm.getDeviceFormName(editDevice))"
                                >
                                  {{ vm.getFieldValidationHints('snmpVersionAuthProtocol', vm.getDeviceFormName(editDevice)) }}
                                </c8y-message>
                              </c8y-messages>
                            </div>
                          </div>
                          <div class="col-sm-6">
                            ...
                            >
                              ...
                              <c8y-messages>
                                <c8y-message
                                  class="form-control-feedback-message"
                                  ng-if="vm.invalid('snmpVersionAuthPassword',vm.getDeviceFormName(editDevice))"
                                >
                                  {{ vm.getFieldValidationHints('snmpVersionAuthPassword', vm.getDeviceFormName(editDevice)) }}
                                </c8y-message>
                              </c8y-messages>
                            </div>
                          </div>
                          ...
                          <div class="col-sm-6">
                            ...
                            >
                              ...
                              <c8y-messages>
                                <c8y-message
                                  class="form-control-feedback-message"
                                  ng-if="vm.invalid('snmpVersionAuthPrivProtocol',vm.getDeviceFormName(editDevice))"
                                >
                                  {{ vm.getFieldValidationHints('snmpVersionAuthPrivProtocol', vm.getDeviceFormName(editDevice)) }}
                                </c8y-message>
                              </c8y-messages>
                            </div>
                          </div>
                          <div class="col-sm-6">
                            ...
                            >
                              ...
                              <c8y-messages>
                                <c8y-message
                                  class="form-control-feedback-message"
                                  ng-if="vm.invalid('snmpVersionAuthPrivPassword',vm.getDeviceFormName(editDevice))"
                                >
                                  {{ vm.getFieldValidationHints('snmpVersionAuthPrivPassword', vm.getDeviceFormName(editDevice)) }}
                                </c8y-message>
                              </c8y-messages>
                            </div>
                          </div>
        ...
        >
          ...
          <fieldset ng-if="vm.newDevice.version === vm.snmpVersions.VERSION_3.value">
            ...
            <div class="tight-grid">
              <div class="col-sm-6">
                <div class="form-group" ng-class="{'has-error': vm.invalid('snmpVersionUsername')}">
                  <label translate>Username</label>
                  <input
                    class="form-control"
                    placeholder="{{ 'e.g. my_username' | translate }}"
            ...
            <div class="tight-grid">
              <div class="col-sm-6">
                <div class="form-group" ng-class="{'has-error': vm.invalid('snmpVersionEngineId')}">
                  <label translate>Engine ID</label>
                  <input
                    class="form-control"
                    placeholder="{{ 'e.g.' | translate }} 45:U9:39:900:FJ8"
      ...
      <div class="card-footer separator" ng-hid="vm.expandedId === 'newDevice'">
        <button
...
<div ng-if="vm.isOPCUATab()">
  <div class="col-lg-12 col-lg-max">
    <div class="card">
      ...
      <div class="card-block">
        <div class="c8y-list__group">
          <div class="c8y-list__item hidden-xs hidden-sm">
            <div class="c8y-list__item__block">
              <div class="c8y-list__item__body">
                <div class="content-flex-60">
                  <div class="col-6">
      ...
      <form ng-if="vm.newDevice" class="bg-gray-lighter" name="vm.newOPCUADeviceForm" novalidate>
        <div class="card-block">
          <div class="row">
            <div class="form-group col-md-4" ng-class="{'has-error': vm.invalid('name')}">
              <input
            ...
            <div class="form-group col-md-4" ng-class="{'has-error': vm.invalid('directoryPath')}">
              <input
                class="form-control input-border"
              ...
              <c8y-messages>
                <c8y-message
                  class="form-control-feedback-message"
                  ng-if="vm.invalid('directoryPath')"
                >
                  {{ vm.getFieldValidationHints('directoryPath') }}
                </c8y-message>
              </c8y-messages>
            </div>
            <div
            ...
            >
              ...
              <c8y-messages>
                <c8y-message
                  class="form-control-feedback-message"
                  ng-if="vm.getFieldValidationHints('deviceType')"
                >
                  {{ vm.getFieldValidationHints('deviceType') }}
                </c8y-message>
              </c8y-messages>
