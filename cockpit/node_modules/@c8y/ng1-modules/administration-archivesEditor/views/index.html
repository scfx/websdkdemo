    ...
    <ul class="timeline-list">
      ...
      >
        ...
        <div class="timeline-item-content flex-row">
          ...
          <div class="list-item-actions" ng-if="!vm.requestInProgress" data-active="{{'Active`archive`' | translate }}">
            <div class="dropdown clearfix" ng-if="!vm.isActiveArchive(archive)" uib-dropdown>
              ...
              >
                <li>
                  <a
                    title="{{ 'Set as active`archive`' | translate }}"
                    href=""
                    ng-click="vm.setActive(archive)"
                    ng-disabled="vm.requestInProgress || refreshLoading"
                  >
                    <i c8y-icon="check-square-o"></i> {{ 'Set as active`archive`' | translate }}
                  </a>
                </li>
                <li ng-if="!$last">
                  <a
