...
<div class="list-group">
  ...
  >
    <div class="flex-row" style="min-height: 32px;">
      <div class="list-item-actions m-r-8 ">
        <button
          type="button"
    ...
    <div uib-collapse="schemaMatch.closed" class="m-t-8">
      <div class="list-group m-b-8">
        <div class="list-group-item bg-gray-lighter d-flex">
        ...
        >
          <div class="list-item-actions  a-s-center">
            <label class="c8y-checkbox input-sm m-r-16">
              <input
                type="checkbox"
                id="audit-select-all"
