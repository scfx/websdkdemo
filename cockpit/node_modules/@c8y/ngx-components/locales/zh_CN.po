...
msgstr ""
"已提供 Actility ThingPark 连接设置。<br>\n"
"            单击下面的 \"更新连接设置\" 可将其覆盖。"
...
msgstr "通过单击下方或操作栏上的按钮添加您的第一个端点。"
...
msgstr ""
"完成流程后，您将不再能够使用\n"
"      <b>{{ vm.resolve.domainName }}</b> 访问租户，请改用新的域名。如果您在访问租户时遇到任何问题，\n"
"      请联系支持人员。"
...
"<strong>库存角色</strong>包含可附加到设备\n"
"组的权限。<br>\n"
"              单击 <i c8y-icon=\"plus-circle\" class=\"text-primary\"></i> 可添加新权限。在\n"
"权限下拉列表中，可以进一步限制对包含\n"
"所定义类型的对象的访问。"
...
msgstr "将仪表板应用于类型为 <i>{{ type }}</i> 的所有设备"
...
msgstr "检查 <span>User guide</span>"
...
msgstr "数据过滤器定义要转发的数据集。您必须至少设置一个过滤器。"
...
msgstr "对角色为 {{ vm.enforcedUsersGroup }} 的用户强制实施双重身份验证。"
...
msgstr "输入您的 SMS 提供商提供的凭据。这将启用利用 SMS 服务的平台功能（例如，双重身份验证和用户通知）。"
...
msgstr ""
"在\n"
"<a c8y-guide-href=\"users-guide/administration/#managing-applications\">User guide</a>中详细了解可用应用程序。"
...
msgstr ""
"在\n"
"            <a c8y-guide-href=\"users-guide/cockpit/#smart-rules\"> User guide </a>中详细了解。"
...
msgstr ""
"在\n"
"          <a c8y-guide-href=\"users-guide/cockpit/#adding-alarms-or-events\">User guide</a>中详细了解。"
...
msgstr ""
"在\n"
"<a c8y-guide-href=\"users-guide/getting-started/\">User guide</a>中详细了解。"
...
msgstr ""
"在\n"
"<a c8y-guide-href=\"users-guide/device-management/#configuration-repository\">User guide</a>中详细了解。"
...
msgstr ""
"在\n"
"      <a c8y-guide-href=\"users-guide/administration/#managing-permissions\">User guide</a>中详细了解。"
...
msgstr ""
"要获得正确的应用程序行为，您只能使用 {{ vm.defaultRedirectUrl }} 或\n"
"              {{ vm.host }} 值，建议使用第一个值。"
...
msgstr "如果选中，您将能够在创建用户后更改 Administration 中分配的角色。否则，角色将在每次登录时与授权服务器同步。"
...
msgstr "必须是有效的产品证书密钥，例如 P_001F_EDCB_01"
...
msgstr "未找到 LoRa 提供程序设置。必须配置连接设置。"
...
msgstr "未配置设备协议。在“设备协议”页面上创建 LoRa 设备协议。"
...
msgstr "打开 <span>User guide</span>"
...
msgstr "可能值：\"true\"、\"false\" 或用户应保持活动状态的特定截止日期，例如 \"{{ exampleDate }}\"。将其留空会将值设置为 \"true\"。"
...
msgstr "选择 \"所有对象\" 选项将同步所有类型的对象，包括内部对象和技术对象（不仅仅限于组和设备）。这可能会导致目标租户出现问题。"
...
msgstr "默认应用程序指定登录平台时默认显示的应用程序。它适用于租户的所有用户。从下面的列表中选择应用程序，并确保所有用户都可以访问此应用程序。"
...
msgstr "此操作可能需要几分钟。在此时间段内，应用程序可能不可用。是否要继续？"
...
msgstr "此仪表板将在类型为 <i>{{ type }}</i> 的所有设备之间共享。"
...
msgstr ""
"此功能已弃用。虽然这仍完全可正常运行，但应改用 \n"
"    <a href=\"/apps/administration#roles\">角色</a>设置权限。"
...
msgstr "您即将删除资产：\"{{name}}\"。此操作无法撤消。是否要继续？"
...
msgstr "您即将从应用程序 \"{{ humanizedAppName }}\" 中删除插件。此操作可能需要几分钟。在此时间段捏，应用程序可能不可用。是否要继续？"
...
msgstr "您可以输入一组 WM2M Shell 命令。其中每个命令都将被发送到每个新注册的 WM2M 设备。"
...
msgstr "您没有管理 {{ vm.user }} 的库存角色所需的权限。"
...
msgstr "您已达到 {{ vm.limitStatus.limit }} 个设备的限制。无法注册更多设备。"
