...
msgstr ""
"Actility ThingPark 接続設定はすでに提供されています。<br>\n"
...
msgstr "下のボタンをクリックしてデバイスを追加します。"

msgid "Add a new command template above."
msgstr "上に新しいコマンド テンプレートを追加してください。"
...
msgstr "アクション バーのボタンを使用して、最初のアラーム マッピングを追加してください。"
...
msgstr "下のボタンまたはアクション バーをクリックして、最初のエンドポイントを追加してください。"
...
msgstr ""
"プロセスの完了後、<b>{{ vm.resolve.domainName }}</b> を使用してテナントにアクセスすることができなくなります。\n"
"     代わりに新しいドメイン名が使用されます。テナントにアクセスする際に問題が発生した場合は、\n"
"サポートに連絡してください。"
...
msgstr "すべての子デバイスはすでにグループに割り当てられています"
...
msgstr "選択したアセットのすべてのデバイスとそのサブアセットも削除します。"
...
msgstr "タイプ <i>{{ type }}</i> のすべてのデバイスにダッシュボードを適用"
...
msgstr "<span>User guide</span> を確認してください"
...
msgstr "子デバイスをグループに割り当てることができません"

msgid "Could not assign devices to the group"
msgstr "デバイスをグループに割り当てることができませんでした"
...
msgstr "データ フィルターは転送するデータのセットを定義します。少なくとも 1 つのフィルターを設定する必要があります。"
...
"        <i class=\"text-primary dlt-c8y-icon-enter-bottom\"></i>\n"
"      </button>\n"
"            を子と一緒にデバイス横に表示します。クリックすると、選択したターゲット デバイスのすべての子デバイスを含む\n"
"リストが表示されます。"
...
msgstr "製品エクスペリエンスを向上するために匿名のトラッキングを有効化"
...
msgid "Enable showing current value in UI (e.g. on Fieldbus widget)."
msgstr "インターフェイスに現在の値の表示を有効化 (例: Fieldbus ウィジェット)。"
...
msgstr "ロール {{ vm.enforcedUsersGroup }} のユーザーに二要素認証を強制してください。"
...
msgstr ""
"詳細は、\n"
"      <a c8y-guide-href=\"users-guide/administration/#managing-permissions\">User guide</a> を参照してください。"
...
"中括弧でその他の式を含まずに        使用される必要があります。(例) <var ng-non-bindable>{{ placeholderName }}</var>        その後、Angular で扱われるバインディングで、この placeholderName を使用できるようになります。\n"
"        事前定義された関数も使用可能です:"
...
msgstr "選択された場合は、ユーザー作成後、[管理] で割り当てられたロールを変更することができます。 その他の場合は、ロールは、ログオンするたびに認証サーバーと同期されます。"
...
msgstr "有効な製品認証キーである必要があります (例: P_001F_EDCB_01)"
...
msgstr "名前、説明、およびデバイス タイプ フィルター"
...
msgstr "LoRa プロバイダー設定が見つかりませんでした。接続性設定を行う必要があります。"
...
msgstr "空きスロットのあるアクティブな契約はありません。"
...
msgstr "デバイス プロトコルが設定されていません。LoRa デバイス プロトコルを [デバイス プロトコル] ページで作成してください。"
...
msgstr "ファームウェアは定義されていません。ファームウェアを追加してください"
...
msgstr "測定の明確なしきい値の場合、アラームを作成"

msgid "On measurement threshold"
msgstr "しきい値の計測時"

msgid "On measurement threshold create alarm"
msgstr "測定のしきい値の場合、アラームを作成"

msgid "On missing measurements"
msgstr "計測値がない場合"

msgid "On missing measurements create alarm"
msgstr "測定がない場合にアラームを作成"
...
msgstr "<span>User guide</span> を開いてください"
...
msgstr ""
"プラグインはこのアプリケーションに現在インストールされています。アプリケーションのアップグレードにより、\n"
"            変更されるプラグインはありません。"
...
msgstr ""
"アプリケーションにプラグインが含まれています。これらのプラグインは、アプリケーションの実行に必要であるため、\n"
"          削除することはできません。"
...
msgstr "範囲の開始および終了値は同じ値であることはできません。"
...
msgstr "フィルターを設定しなおすか、クリアしてください。"
...
msgstr "\"すべてのオブジェクト\" オプションを選択すると、(グループおよびデバイスに限らず)内部および技術オブジェクトを含めたすべてのタイプのオブジェクトが同期されます。これにより対象テナントで問題が発生する可能性があります。"
...
"    server."
msgstr ""
"これらの設定の一部は、認証サーバーを介して管理されているため、ここで編集することは\n"
"できません。"
...
msgstr "TOTP では、[二要素認証を許可する] が有効になっている必要があります。"
...
"                      path"
msgstr ""
"アプリケーションは、同じパスを共有するカスタム アプリケーションにより\n"
"                      上書きされます"
...
msgstr "デフォルト アプリケーションは、プラットフォームにログインする際にデフォルトで表示されるアプリケーションを指定します。これは、テナントのすべてのユーザーに適用されます。下のリストからアプリケーションを選択して、このアプリケーションにすべてのユーザーがアクセスできることを確実にしてください。"
...
msgstr "操作には数分かかる可能性があります。この間、アプリケーションは使用できない場合があります。続行しますか？"
...
msgstr "まだ資格情報が登録されていません。<br>資格情報を登録してください。"
...
msgstr "このアプリケーションにはプラグインは含まれません。"
...
msgstr "このダッシュボードは、タイプ <i>{{ type }}</i> のすべてのデバイス間で共有されます。"
...
msgstr ""
"この機能は廃止されています。まだ完全に機能していますが、アクセス権限を設定するには、\n"
"    <a href=\"/apps/administration#roles\">ロール</a>を使用してください。"
...
msgstr "すべてのデバイスとグループを表示するには、フィルターを使用するか、アセット データ テーブルへ移動してください。"
...
msgstr "現在のテナントのグループを読み込んでいます。お待ちください…"

msgid "Wait while provider settings are loaded…"
msgstr "プロバイダーを読み込んでいます。お待ちください…"
...
msgstr "アセット \"{{name}}\" を削除しようとしています。この操作は元に戻すことはできません。続行しますか？"
...
msgstr "アプリケーション \"{{ humanizedAppName }}\" からプラグインを削除しようとしています。この操作には数分かかる場合があります。この操作中、アプリケーションは使用できない可能性があります。続行しますか？"
...
msgstr "アセット \"{{name}}\"  の割り当てを解除しようとしています。続行しますか？"
...
msgstr "一連の LWM2M シェル コマンドを入力できます。これらの各コマンドは、新しく登録されたすべての LWM2M デバイスに送信されます。"
...
msgstr "{{ vm.user }} のインベントリ ロールを管理するために必要な権限がありません。"
...
msgstr "{{ vm.limitStatus.limit }} デバイスの上限数に達しています。これ以上デバイスを登録することはできません。"
...
msgstr "新しいパスワードを適用するためにログアウトされます。続行しますか？"
...
msgstr "e.g. クラウド接続ソフトウェアが c8y_Linux タイプのデバイスに適用されました"
...
msgstr "{{ deviceCount }} デバイスが選択されました"
