...
export declare class AssetSelectorComponent implements OnInit {
    private groupNodeService;
    /**
     ...
     */
    onChange: EventEmitter<IManagedObject[]>;
    /**
     * @ignore
     */
    rootNode: GroupNode;
     ...
     * @ignore only DI
     */
    constructor(groupNodeService: GroupNodeService);
    /**
     * @ignore
     */
    ngOnInit(): void;
    ...
    getIndexOfSelected(selected: Array<Partial<IManagedObject>>, selectedMo: IManagedObject): number;
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<AssetSelectorComponent, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<AssetSelectorComponent, "c8y-asset-selector", never, { "selected": "selected"; }, { "onChange": "onChange"; }, never, never>;
}
