...
export declare class NavigatorService extends StateService implements ExtensionPoint<NavigatorExtension> {
    ...
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<NavigatorService, never>;
}
export {};
