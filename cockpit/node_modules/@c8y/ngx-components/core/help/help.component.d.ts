...
export declare class HelpComponent {
     ...
     */
    constructor(docsService: DocsService, appState: AppStateService, translateService: TranslateService);
    /**
    ...
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<HelpComponent, "c8y-help", never, { "src": "src"; "isCollapsed": "isCollapsed"; "priority": "priority"; "icon": "icon"; }, {}, never, never>;
}
