...
import { TypeaheadComponent, gettext, FilteringActionType, DataGridComponent, Status, AlertService, CoreModule, HOOK_ROUTE, HOOK_SEARCH } from '@c8y/ngx-components';
...
export { AssetSearchService, SearchBoxComponent, SearchGridComponent, SearchModule, SearchResultsComponent, ɵ0, ɵ1 };
