(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('@c8y/ngx-components/upgrade', ['exports', '@c8y/ngx-components', 'rxjs', 'rxjs/operators', 'lodash-es', '@angular/router', '@angular/core', '@c8y/client', 'angular', '@angular/upgrade/static', '@c8y/ngx-components/app-logs', '@c8y/ngx-components/api', '@c8y/ngx-components/operations/bulk-operations-list', '@ngx-translate/core', '@c8y/ngx-components/context-dashboard', '@angular/common'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global.c8y = global.c8y || {}, global.c8y["ngx-components"] = global.c8y["ngx-components"] || {}, global.c8y["ngx-components"].upgrade = {}), global.c8y["ngx-components"], global.rxjs, global.rxjs.operators, global.lodashEs, global.ng.router, global.ng.core, global.client, global.angular, global.ng.upgrade["static"], global.c8y["ngx-components"]["app-logs"], global.c8y["ngx-components"].api, global.c8y["ngx-components"].operations["bulk-operations-list"], global.core$1, global.c8y["ngx-components"]["context-dashboard"], global.ng.common));
})(this, (function (exports, ngxComponents, rxjs, operators, lodashEs, router, core, client, angular, _static, appLogs, api, bulkOperationsList, core$1, contextDashboard, common) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    Ng1ActionBarFactoryService.decorators = [
    ...
    Ng1NodesFactoryService.decorators = [
        { type: core.Injectable }
    ];
    ...
    Ng1TabsFactoryService.decorators = [
        { type: core.Injectable }
    ];
    ...
    Ng1DocsFactoryService.decorators = [
        { type: core.Injectable }
    ];
    ...
    ServerMessagesService.decorators = [
        { type: core.Injectable }
    ];
    ...
    PasteActionComponent.decorators = [
        { type: core.Component, args: [{
