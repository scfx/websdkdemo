import { OnInit, QueryList, ElementRef, Renderer2, OnDestroy, AfterViewInit } from '@angular/core';
import { GuideHrefDirective } from './guide-href.directive';
import { DocsService } from './docs.service';
import * as ɵngcc0 from '@angular/core';
export declare class GuideDocsComponent implements OnInit, AfterViewInit, OnDestroy {
    private docs;
    private el;
    private renderer;
    baseUrl: string;
    ...
    ngOnDestroy(): void;
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<GuideDocsComponent, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<GuideDocsComponent, "[c8y-guide-docs]", never, {}, {}, ["translateDirective", "links"], ["*"]>;
}
