...
export declare type selectedFunction = (item: Item) => boolean;
export declare type selectedLabelFunction = (items: Item[]) => string;
export declare class SelectComponent implements OnChanges, OnInit {
    ...
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<SelectComponent, "c8y-select", never, { "placeholder": "placeholder"; "applyLabel": "applyLabel"; "disableApplyOnNoSelection": "disableApplyOnNoSelection"; "selectedLabel": "selectedLabel"; "items": "items"; "selected": "selected"; "updateItems": "updateItems"; }, { "onChange": "onChange"; }, ["liChildren"], ["c8y-li"]>;
}
