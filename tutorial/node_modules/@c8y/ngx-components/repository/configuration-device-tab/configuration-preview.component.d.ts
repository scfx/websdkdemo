...
export declare class ConfigurationPreviewComponent implements OnInit, OnDestroy {
    ...
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<ConfigurationPreviewComponent, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<ConfigurationPreviewComponent, "c8y-device-configuration-preview", never, { "isLegacy": "isLegacy"; "configurationType": "configurationType"; "device": "device"; "configSnapshot": "configSnapshot"; "canSaveSnapshot": "canSaveSnapshot"; "actionButtonText": "actionButtonText"; "actionButtonIcon": "actionButtonIcon"; "operationToTrigger": "operationToTrigger"; }, {}, never, never>;
}
