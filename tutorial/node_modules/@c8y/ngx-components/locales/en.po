...
msgstr "Check the <span>User guide</span>"
...
msgstr "Open the <span>User guide</span>"
...
msgstr "Possible values: \"true\", \"false\", or a specific date until the user should remain active, e.g. \"{{ exampleDate }}\". Leaving it blank, will set the value to \"true\"."
...
msgstr "Show devices with active"
