...
msgstr ""
"Actility ThingPark 연결 설정이 이미 제공되었습니다.<br>\n"
"            아래에서 \"연결 설정 업데이트\"를 클릭해 덮어쓰기하십시오."
...
msgstr "아래 버튼을 클릭해 디바이스를 추가하십시오."

msgid "Add a new command template above."
msgstr "위에 새 명령 템플릿을 추가하십시오."
...
msgstr "작업 표시줄의 버튼을 사용하여 첫 번째 경보 매핑을 추가합니다."
...
msgstr "아래 버튼이나 작업 표시줄을 클릭하여 첫 번째 엔드포인트를 추가하십시오."
...
msgstr ""
"프로세스가 완료되면 \n"
"      <b>{{ vm.resolve.domainName }}</b>(으)로 테넌트에 액세스할 수 없게 됩니다. 대신 새 도메인 이름을 사용해야 합니다. 테넌트에 액세스할 수 없다면\n"
"      지원 팀에 문의하십시오."
...
msgstr "모든 하위 디바이스가 이미 그룹에 할당되어 있습니다."
...
msgstr "선택한 자산과 관련 하위 자산에 있는 모든 디바이스도 함께 삭제됩니다."
...
"              defined type."
msgstr ""
"<strong>인벤토리 역할</strong>에는 \n"
"              디바이스 그룹에 첨부할 수 있는 권한이 있습니다.<br>\n"
"              <i c8y-icon=\"plus-circle\" class=\"text-primary\"></i>을(를) 클릭하여 새 권한을 추가하십시오. \n"
"              권한 드롭다운에서 \n"
"              정의된 유형이 포함된 개체에 대한 액세스를 추가로 제한할 수 있습니다."
...
msgstr "<i>{{ type }}</i> 유형의 모든 디바이스에 대시보드 적용"
...
msgstr "관리 작업을 수행하고 파이프라인의 오프로딩을 관리할 수 있습니다"
...
msgstr "데이터 레이크에서 데이터를 대상으로 SQL 쿼리를 실행할 수 있습니다"
...
msgstr "<span>User guide</span>를 확인하십시오."
...
msgstr "아래를 클릭하여 첫 번째 이벤트 처리 규칙을 추가하십시오."
...
msgstr "하위 디바이스를 그룹에 할당할 수 없음"

msgid "Could not assign devices to the group"
msgstr "디바이스를 그룹에 할당할 수 없음"
...
msgstr "데이터 필터는 전달할 데이터 모음을 정의합니다. 최소한 필터 하나는 설정해야 합니다."
...
"        <i class=\"text-primary dlt-c8y-icon-enter-bottom\"></i>\n"
"      </button>\n"
"      버튼을 표시합니다. 버튼을 클릭하면 선택한 대상 디바이스의 모든 하위 디바이스가 포함된\n"
"      목록이 표시됩니다."
...
msgid "Enable showing current value in UI (e.g. on Fieldbus widget)."
msgstr "UI에 현재 값 표시를 활성화합니다(예: Fieldbus 위젯)."
...
msgstr "{{ vm.enforcedUsersGroup }} 역할인 사용자에 대해 2단계 인증을 실행합니다."
...
msgstr ""
"애플리케이션이 올바르게 동작할 수 있도록 {{ vm.defaultRedirectUrl }} 또는\n"
"               {{ vm.host }} 값만 사용할 수 있으며, 첫 번째 값을 사용하는 것이 좋습니다."
...
msgstr "선택할 경우, 사용자 생성 후 관리에서 할당된 역할을 변경할 수 있게 됩니다. 그렇지 않다면, 로그인할 때마다 인증 서버와 역할이 동기화됩니다."
...
msgstr "유효한 제품 인증 키여야 합니다(예: P_001F_EDCB_01)"
...
msgstr "LoRa 공급자 설정을 찾을 수 없습니다. 연결 설정을 구성해야 합니다."
...
msgstr "디바이스 프로토콜이 구성되지 않았습니다. 디바이스 프로토콜 페이지에서 LoRa 디바이스 프로토콜을 생성하십시오."
...
msgstr "측정 시 명시적 임계값으로 알람 생성"

msgid "On measurement threshold"
msgstr "측정 임계치"

msgid "On measurement threshold create alarm"
msgstr "측정 시 임계값으로 알람 생성"

msgid "On missing measurements"
msgstr "측정값 누락"

msgid "On missing measurements create alarm"
msgstr "측정 누락 시 알람 생성"
...
msgstr "<span>User guide</span>를 엽니다."
...
msgstr ""
"현재 플러그인이 이 애플리케이션에 설치되었습니다. 애플리케이션을 업그레이드해도\n"
"            이러한 플러그인은 변경되지 않습니다."
...
msgstr ""
"애플리케이션에 플러그인이 있습니다. 이 플러그인은 \n"
"          애플리케이션 실행에 필요하며 제거할 수 없습니다."
...
msgstr "가능한 값: \"true\", \"false\", 또는 사용자가 활성 상태를 유지해야 하는 날짜입니다(예: \"{{ exampleDate }}\"). 입력하지 않으면 값은 \"true\"로 설정됩니다."
...
msgstr "범위 시작 값과 종료 값은 서로 달라야 합니다."
...
msgstr "\"모든 개체\" 옵션을 선택하면 내부 및 기술 개체를 포함한 모든 유형의 개체가 동기화됩니다(그룹과 장치에만 국한되지 않습니다). 이 경우 대상 테넌트에 문제가 발생할 수 있습니다."
...
msgstr "TOTP를 사용하려면 2단계 인증 활성화를 사용 설정해야 합니다."
...
msgstr "기본 애플리케이션은 플랫폼에 로그인할 때 기본적으로 표시되는 애플리케이션을 지정합니다. 테넌트의 모든 사용자에게 적용됩니다. 아래 목록에서 애플리케이션을 선택하고 모든 사용자가 이 애플리케이션에 액세스할 수 있는지 확인하십시오."
...
msgstr "작업은 몇 분 정도 걸릴 수 있습니다. 작업이 끝날 때까지 애플리케이션을 사용하지 못할 수도 있습니다. 계속하시겠습니까?"
...
msgstr "아직 자격 증명이 입력되지 않았습니다.<br>자격 증명을 입력해주십시오."
...
msgstr "이 대시보드는 <i>{{ type }}</i> 유형의 모든 디바이스에서 공유합니다."
...
msgstr ""
"이 기능은 더 이상 사용하지 않습니다. 여전히 작동하는 기능이지만 권한을 설정하려면 \n"
"    <a href=\"/apps/administration#roles\">역할</a> 을 사용해야 합니다."
...
msgstr "필터를 사용하거나 자산 데이터 테이블로 이동하여 모든 디바이스와 그룹을 표시하십시오."
...
msgstr "현재 테넌트에 대한 그룹을 불러오고 있습니다. 잠시만 기다려주십시오…"

msgid "Wait while provider settings are loaded…"
msgstr "공급자 설정을 로드할 때까지 기다려주십시오…"
...
msgstr "자산 \"{{name}}\"을(를) 삭제합니다. 이 작업은 취소할 수 없습니다. 계속하시겠습니까?"
...
msgstr "\"{{ humanizedAppName }}\" 애플리케이션에서 플러그인을 제거합니다. 이 작업은 몇 분 정도 걸립니다. 애플리케이션을 사용하지 못할 수도 있습니다. 계속하시겠습니까?"
...
msgstr "자산 \"{{name}}\"의 할당을 해제합니다. 계속하시겠습니까?"
...
msgstr "LWM2M 셸 명령 모음을 입력할 수 있습니다. 각 명령은 새로 등록한 모든 LWM2M 장치에 전송됩니다."
...
msgstr "{{ vm.user }}의 인벤토리 역할을 관리하는 데 필요한 권한이 없습니다."
...
msgstr "디바이스 한도 {{ vm.limitStatus.limit }}개에 도달했습니다. 더 이상 디바이스를 등록할 수 없습니다."
...
msgstr "새 암호를 적용하기 위해 로그아웃합니다. 계속하시겠습니까?"
